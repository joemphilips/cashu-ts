...
function lr(e, t) {
	...
	let o = r + i, s = a.flatMap(({ final_expiry: e }) => e === void 0 ? [] : [hr(e, "final_expiry")]).sort((e, t) => e < t ? -1 : +(e > t)), c = a.some(({ final_expiry: e }) => e === void 0) ? s[0] === void 0 ? o : s[0] < o ? s[0] : o : s[0];
	if (c === void 0 || n >= c) throw new v("CTF authorization expiry must precede the effective keyset expiry ceiling");
}
function ur(e) {
