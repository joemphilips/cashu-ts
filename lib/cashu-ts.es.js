...
var it = (e, t, n, r = 1) => rt(e, t, n).length >= r, at = "CASHU_BLS12_381_G1_XMD:SHA-256_SSWU_RO_", ot = u.fields.Fr.ORDER, st = u.G2.Point.BASE, ct = h("Cashu_BLS_Batch_v1"), lt = u.fields.Fr, ut = u.fields.Fp.ORDER;
function N(e) {
	return u.G1.hashToCurve(e, { DST: at });
}
function dt(e, n, r, i) {
	...
	a[0] &= 31;
	let o = n / r;
	for (let e = 0; e < r; e++) if (t(a.subarray(e * o, (e + 1) * o)) >= ut) throw new v(`${i} point non-canonical: coordinate >= p`);
}
function ft(e) {
	dt(n(e), 48, 1, "G1");
...
function mt(e) {
	...
	return st.multiply(t).toBytes(!0);
}
function ht() {
	return lt.fromBytes(i(32));
}
function gt(e, t) {
	let n = N(e);
	if (t === void 0) t = ht();
...
function St(t) {
	...
	let n = st, r = xt(t), i = t[0].C.multiply(r[0]);
...
var Ct = h("Secp256k1_HashToCurve_Cashu_");
function P(t) {
	let n = a(O.concat(Ct, t)), r = new Uint32Array(1), i = 2 ** 16;
	for (let t = 0; t < i; t++) {
...
function At(e, t) {
	let n = P(e);
	if (t === void 0) t = l.Point.Fn.fromBytes(Dt());
	else if (t === 0n) throw new v("Blinding factor r must be non-zero");
...
var Lt = (e) => {
	let t;
	return t = /^[a-fA-F0-9]+$/.test(e) ? $r(e) % BigInt(2 ** 31 - 1) : O.toBigInt(ye(e)) % BigInt(2 ** 31 - 1), t;
}, Rt = "m/0'/0'/0'";
function zt(t) {
	let n = {};
...
function Vt(e, t, n) {
	...
	for (t && (d = g.fromMasterSeed(t)); c < e;) {
		let e = (2n ** c).toString();
		if (d) {
			let t = s === 2 ? `${Rt}/${c}'` : `${Rt}/${c}`, n = d.derive(t).privateKey;
			if (n) u[e] = s === 2 ? a(n) : n;
			else throw new v(`Could not derive Private key from: ${t}`);
		} else u[e] = Dt();
		l[e] = s === 2 ? mt(u[e]) : Et(u[e]), c++;
	}
	return {
		pubKeys: l,
		privKeys: u,
...
function Yt(e, t) {
	return Jt(e).some((e) => e[0] === t);
}
function Xt(e, t) {
	let n = Jt(e).find((e) => e[0] === t);
...
function $t(e, t) {
	...
	return {
		blinded: e.map((e, t) => {
			let r = F(e), i = nn(r, n, t), a = r.add(l.Point.BASE.multiply(i));
...
function tn(e, t, n, r) {
	let i = l.Point.CURVE().n, a = typeof e == "string" ? $r(e) : e, o = typeof t == "string" ? $r(t) : t;
...
function nn(e, t, n) {
	let r = e.multiply(t).toBytes(!0).slice(1), i = new Uint8Array([n & 255]), o = O.toBigInt(a(O.concat(Qt, r, i)));
	if ((o === 0n || o >= l.Point.CURVE().n) && (o = O.toBigInt(a(O.concat(Qt, r, i, new Uint8Array([255])))), o === 0n || o >= l.Point.CURVE().n)) throw new v("P2BK: tweak derivation failed");
	return o;
}
//#endregion
...
var rn = {
	...
	SIG_ALL: "SIG_ALL"
}, an = new Set(Object.values(rn)), on = new Set([
	"locktime",
	"pubkeys",
	"n_sigs",
	"refund",
...
function z(e) {
	let t = Wt(["P2PK", "HTLC"], e);
	Cn(Jt(t));
	let n = Zt(t, "sigflag");
	return n !== void 0 && wn(n), t;
}
function cn(e) {
	let t = e.toLowerCase();
...
function un(e) {
	let t = z(e), n = An(kn(t)), r = Dn(t), i = On(t);
	return n === "ACTIVE" || n === "PERMANENT" ? r : n === "EXPIRED" && i.length ? Array.from(new Set([...r, ...i])) : [];
}
function dn(e) {
	return Zt(z(e), "sigflag") ?? "SIG_INPUTS";
}
function fn(e) {
	return pn(e)?.signatures ?? [];
}
function pn(e) {
	if (!e) return;
	let t;
...
function hn(t, r, i) {
	let a = z(t.secret);
	i = i ?? t.secret;
	let o = typeof r == "string" ? n(r) : r, s = e(c.getPublicKey(o)), l = un(a);
	if (!l.length || !l.some((e) => e.includes(s))) throw new v(`Signature not required from [02|03]${s}`);
	if (fn(t.witness).some((e) => tt(e, i, s))) throw new v(`Proof already signed by [02|03]${s}`);
	let u = et(i, r), d = pn(t.witness), f = {
...
function gn(e, t, n) {
	...
	if (Sn([t]) && !n) throw new v("Cannot verify a SIG_ALL proof without the message to sign");
	return n = n ?? t.secret, fn(t.witness).some((t) => tt(t, n, e));
}
function _n(e, t = C, n) {
	if (Sn([e]) && !n) throw t.error("Cannot verify a SIG_ALL proof without the message to sign"), new v("Cannot verify a SIG_ALL proof without the message to sign");
	n = n ?? e.secret;
	let r = z(e.secret), i = Dn(r), a = On(r);
	En({
		mainKeyCount: i.length,
		refundKeyCount: a.length,
		nSigs: R(r, "n_sigs"),
		nSigsRefund: R(r, "n_sigs_refund"),
		hasLocktime: Number.isFinite(kn(r))
	});
	let o = fn(e.witness), s = kn(r), c = An(s), l = jn(r, c, a), u = Mn(r, c, a), d = rt(o, n, i), f = a.length ? rt(o, n, a) : [], p = {
		locktime: s,
		lockState: c,
		main: {
			pubkeys: i,
...
function wn(e) {
	if (!an.has(e)) throw new v(`Invalid sigflag "${e}": must be "SIG_INPUTS" or "SIG_ALL"`);
}
function Tn(e, t) {
...
function En(e) {
	...
	if (r !== void 0 && (Tn(r, "requiredSignatures (n_sigs)"), r > t)) throw new v(`requiredSignatures (n_sigs) (${r}) exceeds available pubkeys (${t})`);
	if (i !== void 0) {
		if (Tn(i, "requiredRefundSignatures (n_sigs_refund)"), n === 0) throw new v("requiredRefundSignatures (n_sigs_refund) requires refund keys");
...
function Dn(e) {
	let t = Gt(e) === "P2PK" ? qt(e) : "", n = Xt(e, "pubkeys") ?? [], r = (t ? [t, ...n] : n).map((e) => cn(e));
	if (B(r).length !== r.length) throw new v("Duplicate main pubkeys are not allowed");
	return r;
}
function On(e) {
	let t = (Xt(e, "refund") ?? []).map((e) => cn(e));
...
function An(e, t = Math.floor(Date.now() / 1e3)) {
...
var Pn = h("Cashu_DLEQ_R_v1"), Fn = BigInt("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141");
function In(e, n, r, i) {
	let o = f(Pn, n.toBytes(!1), r.toBytes(!1), i.toBytes(!1));
	for (let n = 0; n < 256; n++) {
		let r = t(_(a, e, f(o, new Uint8Array([n])))), i = r >= Fn ? r - Fn : r;
		/* c8 ignore next */
		if (i !== 0n) return i;
	}
	/* c8 ignore next */
...
var Ln = (e, t, n, r) => {
	let i = l.Point.Fn.fromBytes(e.s), a = l.Point.Fn.fromBytes(e.e), o = l.Point.BASE.multiply(i), s = r.multiply(a), c = t.multiply(i), u = n.multiply(a), d = wt([
		o.subtract(s),
		c.subtract(u),
		r,
		n
	...
	return Ln(t, i.add(o), a, r);
}, zn = (e, t) => {
	let n = l.Point.Fn.fromBytes(t), i = l.Point.BASE.multiply(n), a = e.multiply(n), o = In(t, i, e, a), s = wt([
...
}, Bn = "m/129372'/0'", Vn = BigInt("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141"), Hn = /* @__PURE__ */ function(e) {
	return e[e.DEPRECATED_BIP32 = 0] = "DEPRECATED_BIP32", e[e.HMAC_SHA256 = 1] = "HMAC_SHA256", e;
}(Hn || {}), Un = (e, t, n) => Gn(e, t, n).secret, Wn = (e, t, n) => Gn(e, t, n).blindingFactor;
function Gn(e, t, n) {
	return Kn(e, t)(n);
}
function Kn(e, t) {
	switch (qn(t)) {
		case Hn.DEPRECATED_BIP32: {
			let n = g.fromMasterSeed(e);
			return (e) => Jn(n, t, e);
		}
		case Hn.HMAC_SHA256: return (n) => Yn(e, t, n);
	}
}
function qn(e) {
	let t = /^[a-fA-F0-9]+$/.test(e);
	if (!t && Se(e) || t && e.startsWith("00")) return Hn.DEPRECATED_BIP32;
	if (t && (e.startsWith("01") || e.startsWith("02"))) return Hn.HMAC_SHA256;
	throw new v(`Unrecognized keyset ID version ${e.slice(0, 2)}`);
}
function Jn(e, t, n) {
	let r = `${Bn}/${Lt(t)}'/${n}'`, i = e.derive(r), a = i.deriveChild(0).privateKey, o = i.deriveChild(1).privateKey;
	/* c8 ignore next */
...
function Xn(e, t, n) {
	if (I(n)) {
		for (let n = 0; n < 65536; n++) {
			...
			if (!(o === 0n || o >= ot)) return i;
		}
		/* c8 ignore next */
		throw new v("V3 blinding factor derivation failed");
	}
	let i = _(a, e, O.concat(t, O.fromHex("01"))), o = O.toBigInt(i), s = o >= Vn ? o - Vn : o;
	/* c8 ignore next */
...
function tr(e, t = C, n) {
	let r;
	n = n ?? e.secret;
	let i = L(e.secret), a = _n(e, t, n);
	if (a.path != "MAIN" || Gt(i) !== "HTLC") return a;
	let o = rr(e.witness);
	return o ? er(o, qt(i)) ? (r = a, t.debug("Spending condition satisfied via hashlock (receiver) pathway", { result: r }), r) : (r = {
		...a,
		success: !1,
		path: "FAILED"
...
}({}), cr = 1, lr = 2, ur = 3, dr = 4, fr = 5, pr = 6, mr = 7, hr = 8, gr = 1, _r = 2, vr = 3, yr = 0, br = 1, xr = 1, Sr = 2, Cr = 3, wr = 0, Tr = 1;
function Er(e) {
	let t = Dr(e), n = {};
	for (let e of t) switch (e.tag) {
		...
		case pr:
			...
			break;
		case mr:
			n.transports || (n.transports = []), n.transports.push(Nr(e.value));
			break;
		case hr:
			n.nut10 || (n.nut10 = []), n.nut10.push(Pr(e.value));
			break;
		default: break;
	}
	return n;
...
function Ir(e) {
	let t = [];
	if (e.id && t.push(H(cr, Lr(e.id))), e.amount !== void 0 && t.push(H(lr, Rr(e.amount))), e.unit && (e.unit === "sat" ? t.push(H(ur, new Uint8Array([0]))) : t.push(H(ur, Lr(e.unit)))), e.singleUse !== void 0 && t.push(H(dr, zr(+!!e.singleUse))), e.mints && e.mints.length > 0) for (let n of e.mints) t.push(H(fr, Lr(n)));
	if (e.description && t.push(H(pr, Lr(e.description))), e.transports && e.transports.length > 0) for (let n of e.transports) t.push(H(mr, Hr(n)));
	if (e.nut10 && e.nut10.length > 0) for (let n of e.nut10) t.push(H(hr, Ur(n)));
...
function Br(e) {
	switch (e) {
		case sr.NOSTR: return yr;
		case sr.POST: return br;
...
function Hr(e) {
	...
	let r, i = [];
	if (e.type === sr.NOSTR) {
		let { pubkey: t, relays: n } = Gr(e.target);
		r = t, i = n.map((e) => ["r", e]);
	} else r = Lr(e.target);
	t.push(H(_r, r));
	let a = [...i, ...e.tags || []];
	if (a.length > 0) for (let e of a) t.push(H(vr, Wr(e)));
...
function Ur(e) {
	let t = [], n = Vr(e.kind);
	if (t.push(H(xr, zr(n))), t.push(H(Sr, Lr(e.data))), e.tags && e.tags.length > 0) for (let n of e.tags) t.push(H(Cr, Wr(n)));
...
function U(e, t, n, r) {
	let i = Qr(e, "splitAmount.value", !0), a = n?.map((e) => Qr(e, "splitAmount.split", !0));
	if (a) {
		let e = A.sum(a);
		...
		if (n.some((e) => !Zr(e, t))) throw new v("Provided amount preferences do not match the amounts of the mint keyset.");
...
function Zr(e, t) {
	return Qr(e, "hasCorrespondingKey.amount", !0).toString() in t;
}
function Qr(e, t, n = !1) {
	let r = A.from(e);
...
function ii(e, t) {
	let n = J(e.proofs);
	if (ti(n)) throw new v("Proofs contain a legacy keyset ID and cannot be encoded. Swap them at the mint first.");
	return ai({
		...e,
		proofs: n
	}, t?.removeDleq);
...
function ai(e, t) {
	let n = e.proofs;
	if (t && (n = yi(n)), n.forEach((e) => {
		if (e.dleq && e.dleq.r == null) throw new v("Missing blinding factor in included DLEQ proof");
	}), ti(n)) throw new v("can not encode to v4 token if proofs contain non-hex keyset id");
	return n = ri(n), "cashuB" + _e(ke(oi({
		...e,
		proofs: n
	})));
}
...
function ci(e, t = []) {
	let n = ui(Ti(e));
	return n.proofs = bi(n.proofs, t), n;
}
function li(e) {
	e = Ti(e);
	let t = ui(e);
...
function di(e, t) {
	...
	switch (o) {
		case 0: {
			let t = a(fi(...Object.entries(e).sort(([e], [t]) => A.from(e).compareTo(t)).map(([, e]) => n(e))));
...
function vi(e) {
	return Jr.fromEncodedRequest(e);
}
function yi(e) {
	return e.map((e) => {
		let { dleq: t, ...n } = e;
...
function xi(e, t, r) {
	let i = r?.require ?? !1;
	if (!Zr(e.amount, t.keys)) throw new v(`Undefined key for amount ${e.amount.toString()} in keyset ${t.id}`);
	if (I(e.id)) try {
		return bt(pt(t.keys[e.amount.toString()]), ft(e.C), new TextEncoder().encode(e.secret));
	} catch {
		return !1;
	}
	...
	try {
		...
		return Rn(new TextEncoder().encode(e.secret), t, F(e.C), F(a));
	} catch {
		return !1;
	}
}
function Si(e, t, n) {
	...
	for (let e of s) if (!xi(e, t(e.id), { require: i })) throw new v(a + c(e));
	if (o.length === 0) return;
	let l = o.map((e) => {
		let n = t(e.id);
		if (!Zr(e.amount, n.keys)) throw new v(`Undefined key for amount ${e.amount.toString()} in keyset ${n.id}`);
		let r, i;
		try {
			r = pt(n.keys[e.amount.toString()]), i = ft(e.C);
		} catch {
			throw new v(a + c(e));
		}
		return {
	...
	if (l.length === 1) {
		let e = l[0];
		if (!bt(e.K2, e.C, e.secret)) throw new v(a + c(e.proof));
		return;
	}
	if (!St(l)) {
		for (let e of l) if (!bt(e.K2, e.C, e.secret)) throw new v(a + c(e.proof));
		throw new v(a);
	}
}
function Ci(e) {
	let t = new TextEncoder(), n = J(e.proofs), r = ke(oi({
		...e,
		proofs: n
	}));
	return fi(t.encode("craw"), t.encode("B"), r);
}
function wi(e) {
...
var ki = class e {
	...
	static normalizeSwapMethods(e) {
		return e.map((e) => {
			let t = { ...e };
			return mi(t, "min_amount", "max_amount"), t;
		});
	}
...
var Pi = Ni(globalThis);
function Fi(e, t, n = Pi) {
	return {
...
var Vi = 9, Hi = 1e3, Ui = 100, Wi = class e extends b {
	constructor(t) {
		super(t), this.name = "CallerAbortError", Object.setPrototypeOf(this, e.prototype);
	}
};
function Gi(e) {
	return e instanceof Wi ? !1 : e instanceof b ? !0 : e instanceof y && e.status >= 500;
}
function Ki(e, t) {
	return t ? new Promise((n, r) => {
		if (t.aborted) {
			r(new Wi("Request aborted by caller"));
			return;
		}
		let i = () => {
			clearTimeout(a), t.removeEventListener("abort", i), r(new Wi("Request aborted by caller"));
		};
...
async function Yi(e) {
	let { ttl: t, cached_endpoints: n, endpoint: r } = e, i = qi(r), a = e.method?.toUpperCase() ?? "GET";
	if (!(i !== void 0 && n?.some((e) => Ji(i, e.path) && e.method === a) && t)) return await Xi(e);
	let o = 0, s = Date.now(), c = async () => {
		try {
			...
			if (Gi(n)) {
				let r = Date.now() - s;
				if (o < Vi && (!t || r < t)) {
					let i = Math.min(2 ** o * Ui, Hi), a = Math.random() * i;
...
async function Xi(e) {
	let { endpoint: t, requestBody: n, headers: r, requestTimeout: i, onResponseMeta: a, cached_endpoints: o, ttl: s, logger: c, ...l } = e, u = n ? j.stringify(n) : void 0, d = Fi(u, r), f = e.signal ?? void 0;
	if (f?.aborted) throw new Wi("Request aborted by caller");
	...
	try {
		...
		throw t ? new b(`Request timed out after ${i}ms`, { cause: e }) : n ? new Wi(Ii(e, "Request aborted by caller")) : e instanceof Error && (e.name === "AbortError" || e.name === "TimeoutError") ? new b(e.message, { cause: e }) : new b(Ii(e, "Network request failed"), { cause: e });
	} finally {
		clearTimeout(h), g?.();
	}
	let C = Li(_.headers.get("Retry-After"));
	if (a && _.headers && E(a, {
		endpoint: t,
		status: _.status,
		retryAfterMs: C,
...
async function Qi(e) {
	let t = e.onResponseMeta, n = Ri.onResponseMeta, r = {
		...e,
		...Ri
	};
...
var $i;
typeof WebSocket < "u" && ($i = WebSocket);
function ea(e) {
	$i = e;
}
function ta() {
	if ($i === void 0) throw new v("WebSocket implementation not initialized");
	return $i;
}
//#endregion
...
var na = class {
	...
	constructor(e, t) {
		this.subListeners = {}, this.rpcListeners = {}, this.rpcId = 0, this.onCloseCallbacks = [], this._WS = ta(), this.url = new URL(e), this.messageQueue = new ra(), this._logger = t ?? C;
	}
	setLogger(e) {
		this._logger = e;
	}
	...
	constructor(e, t) {
		...
		}, this._mintUrl = hi(e), this._request = t?.customRequest ?? Qi, this._authProvider = t?.authProvider, this._logger = t?.logger ?? C, Bi(this._logger);
	}
	get mintUrl() {
	...
	async oidcAuth(e) {
		...
		return new ki(t.openid_discovery, {
			...e,
	...
	async check(e, t) {
		...
		for (let e of n.states) mi(e, "witness");
		return n;
	}
	async getKeys(e, t, n) {
	...
	async getCtfCondition(e, t) {
		...
		let n = e.toLowerCase(), r = await this.getCtfConditionResponse(n, t), i = r, a = G(i.condition) ? i.condition : r;
		if (!G(a) || a.condition_id?.toLowerCase() !== n || !Array.isArray(a.partitions)) throw this._logger.error("Invalid response from mint...", {
			data: r,
			op: "getCtfCondition"
	...
	async ctfSplit(e, t) {
		...
		}, r = await this.requestWithAuth("POST", "/v1/ctf/split", { requestBody: n }, t);
		...
		for (let [e, t] of Object.entries(r.signatures)) {
			if (!Array.isArray(t)) throw this._logger.error("Invalid response from mint...", {
				data: r,
				op: "ctfSplit"
			}), new v(`Mint returned invalid CTF split signatures for ${e}`);
	...
	async connectWebSocket() {
		try {
			let e = new URL(this._mintUrl), t = "v1/ws";
			e.pathname.endsWith("/") ? e.pathname += t : e.pathname += "/" + t, e.protocol = e.protocol === "https:" ? "wss:" : "ws:";
			let n = e.toString();
			this.ws || (this.ws = new ia(n, this._logger)), await this.ws.ensureConnection();
		} catch (e) {
	...
	normalizeMintQuoteBolt12Fields(e) {
		mi(e, "amount"), e.amount = e.amount === null ? null : A.from(e.amount), e.expiry = Y(e.expiry, "mintQuoteBolt12.expiry", null), e.amount_paid = A.from(e.amount_paid), e.amount_issued = A.from(e.amount_issued);
	}
	...
	normalizeMeltOnchainFields(e) {
		...
		}), mi(e, "selected_fee_index", "outpoint"), typeof e.request != "string" || e.selected_fee_index !== null && !Number.isSafeInteger(e.selected_fee_index) || e.outpoint !== null && typeof e.outpoint != "string")) throw this._logger.error("Invalid response from mint...", {
			data: e,
			op: "onchain melt quote"
		}), Error("Invalid response from mint");
	}
	...
	constructor(e, t, n, r, i) {
		this._keys = {}, this._id = e, this._unit = t, this._active = n, this._input_fee_ppk = r, this._final_expiry = i;
	}
	get id() {
		return this._id;
	}
	...
	verify() {
		return this.hasKeys ? e.verifyKeysetId(this.toMintKeys()) : !1;
	}
	...
	static fromMintApi(t, n) {
		let r = Di(t), i = n ? Oi(n) : void 0, a = new e(r.id, r.unit, r.active, r.input_fee_ppk, r.final_expiry);
		if (i) {
	...
	constructor(e, t) {
		this.keysets = {}, this.pendingKeyFetches = /* @__PURE__ */ new Map(), this.mint = typeof e == "string" ? new aa(e) : e, this.unit = t;
	}
	...
	buildKeychain(e, t) {
		...
		for (let t of e) {
			let e = n.get(t.id), r = e ? oa.fromMintApi(t, e) : oa.fromMintApi(t);
	...
	getCheapestKeyset() {
		if (Object.keys(this.keysets).length === 0) throw new v("KeyChain not initialized");
		let e = Object.values(this.keysets).filter((e) => e.unit === this.unit && e.isActive && e.hasHexId && e.hasKeys);
	...
	async ensureKeysetKeys(e) {
		...
		let r = (async () => {
			...
			let r = t.toMintKeyset(), i = oa.fromMintApi(r, n);
	...
	getKeysets() {
		...
		let e = Object.values(this.keysets).filter((e) => e.unit === this.unit);
...
}, la = 1024, ua = "Inputs may already be spent; if the wallet is seeded, try restoring (NUT-09) to recover.", da = new Set([
	"locktime",
	"pubkeys",
	"n_sigs",
	"refund",
...
function fa(e) {
	...
	if (da.has(e)) throw new v(`additionalTags must not use reserved key "${e}"`);
}
var Q = class e {
	constructor(e, t, n, r) {
	...
	toProof(e, t) {
		if (e == null) throw new v(`Mint response is missing a signature for one of the outputs. ${ua}`);
		...
		if (!n.isZero() && !e.amount.equals(n)) throw new v(`Mint signature amount ${e.amount.toString()} does not match requested amount ${n.toString()}. ${ua}`);
		if (I(e.id)) {
			let n, r;
			try {
				...
				throw new v(`Mint returned invalid signature or amount. ${ua}`, { cause: e });
			}
			let i = vt({
				id: e.id,
				C_: n
			}, this.blindingFactor, this.secret);
			if (!bt(r, i.C, i.secret)) throw new v("BLS pairing verification failed on mint response");
			let a = {
				id: e.id,
				amount: e.amount,
				C: i.C.toHex(!0),
		...
		if (e.dleq && (a = {
			...
			let e = Ft(this.blindedMessage.B_);
			if (e.kind === "secp" && !Ln(a, e.pt, i, r)) throw new v("DLEQ verification failed on mint response");
		}
		let o = Mt({
			id: e.id,
			C_: i
	...
	static createSingleP2PKData(t, n, r) {
		let i = A.from(n), a = ln(t), o = Array.isArray(a.pubkey) ? a.pubkey : [a.pubkey], s = a.refundKeys ?? [], c = a.requiredSignatures ?? 1, l = a.requiredRefundSignatures ?? 1, u = a.hashlock, f = typeof u == "string" && u.length > 0, p = f ? u : o[0], h = f ? o : o.slice(1), g = s, _;
		if (t.blindKeys) {
			let { blinded: e, Ehex: t } = $t([...o, ...s]);
		...
		if (Number.isSafeInteger(b) && b >= 0 && y.push(["locktime", String(b)]), h.length > 0 && (y.push(["pubkeys", ...h]), c > 1 && y.push(["n_sigs", String(c)])), g.length > 0 && (y.push(["refund", ...g]), l > 1 && y.push(["n_sigs_refund", String(l)])), a.sigFlag == "SIG_ALL" && y.push(["sigflag", "SIG_ALL"]), a.additionalTags?.length) {
			let e = a.additionalTags.map(([e, ...t]) => (fa(e), [e, ...t.map(String)]));
			y.push(...e);
		}
		let x = [f ? "HTLC" : "P2PK", {
			nonce: d(m(32)),
		...
		if (C > 1024) throw new v(`Secret too long (${C} characters), maximum is ${la}`);
		let w = new TextEncoder().encode(S), { r: T, B_: ee } = ma(w, r);
		return new e(new ca(i, ee, r).getSerializedBlindedMessage(), T, w, _);
	}
	...
	static createSingleRandomData(t, n) {
		let r = A.from(t), i = d(m(32)), a = new TextEncoder().encode(i), { r: o, B_: s } = ma(a, n);
		return new e(new ca(r, s, n).getSerializedBlindedMessage(), o, a);
	}
	static createDeterministicData(e, t, n, r, i) {
		let a = U(e, r.keys, i), o = Kn(t, r.id);
		return a.map((e, t) => pa(e, r.id, o(n + t)));
	}
	static createSingleDeterministicData(e, t, n, r) {
		return pa(e, r, Gn(t, r, n));
	}
...
function pa(e, t, n) {
	let r = A.from(e), i = d(n.secret), a = new TextEncoder().encode(i), { r: o, B_: s } = ma(a, t, O.toBigInt(n.blindingFactor));
	return new Q(new ca(r, s, t).getSerializedBlindedMessage(), o, a);
}
function ma(e, t, n) {
	if (I(t)) {
		let t = gt(e, n);
...
var ga = class e {
	...
	lockUntil(e) {
		return this.locktime = ha(e), this;
	}
...
function Ea(e) {
	return e instanceof Error ? e : new v(typeof e == "string" ? e : Ta(e), { cause: e });
}
function Da() {
...
var Oa = class {
	...
	waitUntilPaid(e, t, n, r = "Timeout waiting for paid") {
		return new Promise((i, a) => {
			let o = null, s = null, c = !1, l = (e) => {
				c || (c = !0, $(o), s && (clearTimeout(s), s = null), n?.signal && n.signal.removeEventListener("abort", u), e && a(Ea(e)));
			}, u = () => l(Da());
			if (n?.signal) {
		...
		return new Promise((n, r) => {
			let i = Array.from(new Set(e)), a = /* @__PURE__ */ new Map(), o = null, s = null, c = !1, l = !1, u = (e) => {
				if (!l) {
					...
					a.clear(), o && (clearTimeout(o), o = null), t?.signal && t.signal.removeEventListener("abort", d), e && r(Ea(e));
				}
			}, d = () => u(Da());
			if (t?.signal) {
	...
	send(e, t) {
		return new Aa(this.wallet, e, t);
	}
	receive(e) {
		return new ja(this.wallet, e);
	}
	mintBolt11(e, t) {
		return new Ma(this.wallet, "bolt11", e, t);
	}
	mintBolt12(e, t) {
		return new Ma(this.wallet, "bolt12", e, t);
	}
	mintOnchain(e, t) {
		return new Ma(this.wallet, "onchain", e, t);
	}
	meltBolt11(e, t) {
...
}, Fa = "__PENDING__", Ia = class e {
	constructor(e, t) {
		this._seed = void 0, this._unit = "sat", this._mintInfo = void 0, this._denominationTarget = 3, this._secretsPolicy = "auto", this._boundKeysetId = Fa, this._requireSigDleq = !1, this.ops = new ka(this), this.on = new Oa(this), this._logger = t?.logger ?? C, this._selectProofs = t?.selectProofs ?? _a, this._outputDataCreator = t?.outputDataCreator ?? new va(), this.mint = typeof e == "string" ? new aa(e, {
			authProvider: t?.authProvider,
			logger: this._logger
		}) : e, this._unit = t?.unit ?? this._unit, this._boundKeysetId = t?.keysetId ?? this._boundKeysetId, t?.bip39seed && (this.failIf(!(t.bip39seed instanceof Uint8Array), "bip39seed must be a valid Uint8Array", { bip39seed: t.bip39seed }), this._seed = t.bip39seed), this._secretsPolicy = t?.secretsPolicy ?? this._secretsPolicy, t?.counterSource ? this._counterSource = t.counterSource : this._counterSource = new Sa(t?.counterInit), this.counters = new wa(this._counterSource), this._keyChain = new sa(this.mint, this._unit), this._denominationTarget = t?.denominationTarget ?? this._denominationTarget, this._requireSigDleq = t?.requireSigDleq ?? this._requireSigDleq;
	}
	fail(e, t) {
	...
	finishInit() {
		if (this._logger.debug("KeyChain", { keychain: this._keyChain.cache }), this._boundKeysetId === Fa) try {
	...
	get keysetId() {
		return this.failIf(this._boundKeysetId === Fa, "Wallet has no bound keyset. The mint may have no active keysets, or wallet was not initialized via loadMint or loadMintFromCache"), this._boundKeysetId;
	}
	getKeyset(e) {
	...
	configureOutputs(e, t, n, r = !1, i = []) {
		...
		if (s.length === 0 && o.length > 0 && (s = ba(o, a, t.keys, this._denominationTarget)), s = U(a, t.keys, s), r) {
	...
	createSwapTransaction(e, t, n = []) {
		...
		Sn(e) || i.sort((e, t) => r[e].blindedMessage.amount.compareTo(r[t].blindedMessage.amount));
	...
	async prepareSwapToReceive(e, t, n) {
		...
		if (Array.isArray(e)) s = J(e);
			...
			let t = typeof e == "string" ? this.decodeToken(e) : e, n = hi(t.mint);
		...
		this.failIf(u.isZero(), "Token contains no proofs", { proofs: s }), Si(s, (e) => this._keyChain.getKeyset(e), { requireDleq: i });
	...
	async prepareConditionalSwap(e) {
		...
		let i = (await this.mint.getKeys(n)).keysets.find((e) => e.id === n);
		if (!i || Object.keys(i.keys).length === 0) throw new v(`Mint returned no keys for conditional keyset ${n}`);
		let a = /* @__PURE__ */ new Set(), o = A.zero(), s = e.outputs.map((e) => {
		...
		}), c = A.from(Math.ceil(t.length * (i.input_fee_ppk ?? 0) / 1e3)), l = q(t).subtract(c);
	...
	async completeConditionalSwap(e) {
		...
		let i = (await this.mint.getKeys(e.keysetId)).keysets.find((t) => t.id === e.keysetId);
		if (!i || Object.keys(i.keys).length === 0) throw new v(`Mint returned no keys for conditional keyset ${e.keysetId}`);
		let a = {}, o = 0;
	...
	signP2PKProofs(e, t, n, r) {
		let i = J(e);
		if (!Sn(i)) return mn(i, t, this._logger);
		this.failIfNullish(n, "OutputData is required for SIG_ALL proof signing."), bn(i);
		let [a, ...o] = i, s = a, c = [Nn(i, n, r), xn(i, n, r)];
		for (let e of c) s = mn([s], t, this._logger, e)[0];
		return [s, ...o];
	}
	getFeesForProofs(e) {
	...
	decodeToken(e) {
		return ci(e, this._keyChain.getAllKeysetIds());
	}
	...
	async prepareMint(e, t, n, r, i) {
		...
		if ("pubkey" in n && n.pubkey && this.failIf(!o, "Can not sign locked quote without private key"), o) {
			...
			this.failIf(!t, "prepareMint: privkey is empty or correct privkey not provided"), g.signature = ar(t, n.quote, h);
		}
		return {
			method: e,
			payload: g,
	...
	async prepareBatchMint(e, t, n, r) {
		...
		for (let e of t) {
			...
			if (t && s) {
				let n = nt(t, s);
				v.push(ar(n, e.quote.quote, _)), y = !0;
	...
	async createMeltQuoteBolt11(e, t) {
		...
		t !== void 0 && this.failIf(Ei(e), "amountMsat supplied but invoice already contains an amount. Leave amountMsat undefined for non-zero invoices.");
	...
	async checkProofsStates(e) {
		let t = new TextEncoder(), n = e.map((e) => I(e.id) ? N(t.encode(e.secret)).toHex(!0) : P(t.encode(e.secret)).toHex(!0)), r = [];
	...
	constructor(e, t) {
		this.tokens = {}, this.pool = [], this.desiredPoolSize = 100, this.maxPerMint = 100, this.mintUrl = e, this.req = t?.request ?? Qi, this.logger = t?.logger ?? C;
	...
	async init() {
		...
		if (!this.keychain) {
			let [e, t] = await Promise.all([this.req({
				...
				method: "GET"
			})]), n = e.keysets.map((e) => Di(e)), r = t.keysets.map((e) => Oi(e)), i = sa.mintToCacheDTO(this.mintUrl, n, r);
			this.keychain = sa.fromCache(this.mintUrl, "auth", i), this.keychain.getCheapestKeyset();
		}
	}
	getBatMaxMint() {
...
var Va = "sigallA";
function Ha(e, t, n) {
	let r = t.map((e) => ({ blindedMessage: e })), i = Nn(e, r, n), a = xn(e, r, n);
	return {
		legacy: Qe(i, !0),
		current: Qe(a, !0)
	};
...
function Ua(e) {
	...
	let n = j.stringify(t) ?? "{}";
	return `${Va}${_e(O.fromString(n))}`;
}
function Wa(e, t) {
	if (!e.startsWith(Va)) throw new v(`Invalid signing package: must start with "${Va}"`);
	let n = e.slice(7), r;
	try {
	...
	let a = i, o = a.version;
	if (o !== Va) throw new v(`Invalid signing package version: ${o}`);
	let s = a.type;
	...
	if (t?.validateDigest) {
		let e = Ha(a.inputs, a.outputs, a.quote);
...
function Ka(e) {
	...
	return Ja("swap", e.inputs, t.map((e) => e.blindedMessage));
}
function qa(e) {
	return Ja("melt", e.inputs, e.outputData.map((e) => e.blindedMessage), e.quote.quote);
}
function Ja(e, t, n, r) {
	let i = Ha(t, n, r), a = Qe(xn(t, n.map((e) => ({ blindedMessage: e })), r), !0);
...
function Za(e, t) {
	...
	let [n, ...r] = e, i = pn(n.witness), a = i?.signatures ?? [];
	return [{
		...n,
		witness: {
			...i ?? {},
...
var Qa = {
	computeDigests: Ha,
	extractSwapPackage: Ka,
	extractMeltPackage: qa,
	serializePackage: Ua,
	deserializePackage: Wa,
	signPackage: Ga,
	signDigest: $e,
	mergeSwapPackage: Ya,
	mergeMeltPackage: Xa
...
//#endregion
export { A as Amount, k as AmountError, ae as AmountWithUnit, ie as AmountWithUnitError, Ra as AuthManager, ot as BLS_FR_ORDER, st as BLS_G2_GENERATOR, at as BLS_HASH_TO_CURVE_DST, v as CTSError, aa as CashuMint, aa as Mint, Ia as CashuWallet, Ia as Wallet, Mi as CheckStateEnum, te as ConsoleLogger, y as HttpResponseError, j as JSONInt, sa as KeyChain, oa as Keyset, Na as MeltBuilder, Pa as MeltOnchainBuilder, ji as MeltQuoteState, Ma as MintBuilder, X as MintInfo, S as MintOperationError, Ai as MintQuoteState, b as NetworkError, ki as OIDCAuth, Q as OutputData, Qt as P2BK_DST, ga as P2PKBuilder, Jr as PaymentRequest, sr as PaymentRequestTransportType, x as RateLimitError, ja as ReceiveBuilder, Aa as SendBuilder, Qa as SigAll, rn as SigFlags, ia as WSConnection, wa as WalletCounters, Oa as WalletEvents, ka as WalletOps, Pt as asBlsG1Point, Nt as asSecpPoint, Wt as assertSecretKind, bn as assertSigAllInputs, St as batchVerifyUnblindedSignatureBls, ni as bigIntStringify, At as blindMessage, gt as blindMessageBls, Nn as buildLegacyP2PKSigAllMessage, xn as buildP2PKSigAllMessage, Qe as computeMessageDigest, Mt as constructUnblindedSignature, vt as constructUnblindedSignatureBls, Ba as createAuthWallet, Ot as createBlindSignature, yt as createBlindSignatureBls, zn as createDLEQProof, Ca as createEphemeralCounterSource, $n as createHTLCHash, Zn as createHTLCsecret, Vt as createNewMintKeys, sn as createP2PKsecret, kt as createRandomRawBlindedMessage, Dt as createRandomSecretKey, Ut as createSecret, Kn as createSecretAndBlindingFactorDeriver, vi as decodePaymentRequest, B as dedupeP2PKPubkeys, xt as deriveBatchWeights, Wn as deriveBlindingFactor, di as deriveKeysetId, $t as deriveP2BKBlindedPubkeys, tn as deriveP2BKSecretKey, en as deriveP2BKSecretKeys, Un as deriveSecret, Gn as deriveSecretAndBlindingFactor, Bt as deserializeMintKeys, _i as deserializeProofs, nt as findSigningKey, qt as getDataField, ci as getDecodedToken, wi as getDecodedTokenBinary, ii as getEncodedToken, ii as getEncodedTokenV4, Ci as getEncodedTokenBinary, mt as getG2PubKeyFromPrivKey, rr as getHTLCWitnessPreimage, Yr as getKeysetAmounts, Lt as getKeysetIdInt, un as getP2PKExpectedWitnessPubkeys, dn as getP2PKSigFlag, fn as getP2PKWitnessSignatures, Et as getPubKeyFromPrivKey, Kt as getSecretData, Gt as getSecretKind, Xt as getTag, R as getTagInt, Zt as getTagScalar, Jt as getTags, li as getTokenMetadata, rt as getValidSigners, Zr as hasCorrespondingKey, gn as hasP2PKSignedProof, Yt as hasTag, xi as hasValidDleq, P as hashToCurve, N as hashToCurveBls, wt as hash_e, $r as hexToNumber, ea as injectWebSocketImpl, Ei as invoiceHasAmountInHRP, I as isBlsKeyset, nr as isHTLCSpendAuthorised, G as isObj, Sn as isP2PKSigAll, vn as isP2PKSpendAuthorised, W as isValidHex, K as joinUrls, yn as maybeDeriveP2BKPrivateKeys, it as meetsSignerThreshold, ln as normalizeP2PKOptions, J as normalizeProofAmounts, hi as normalizeUrl, mi as nullIfUndefined, ei as numberToHexPadded64, Qn as parseHTLCSecret, z as parseP2PKSecret, L as parseSecret, pn as parseWitnessData, Tt as pointFromBytes, F as pointFromHex, Ft as pointFromHexAuto, ft as pointFromHexG1, pt as pointFromHexG2, It as pointToHex, $e as schnorrSignDigest, et as schnorrSignMessage, tt as schnorrVerifyMessage, _a as selectProofsRGLI, zt as serializeMintKeys, gi as serializeProofs, zi as setGlobalRequestOptions, ar as signMintQuote, hn as signP2PKProof, mn as signP2PKProofs, pi as sortProofsById, U as splitAmount, yi as stripDleq, q as sumProofs, jt as unblindSignature, _t as unblindSignatureBls, Ln as verifyDLEQProof, Rn as verifyDLEQProof_reblind, er as verifyHTLCHash, tr as verifyHTLCSpendingConditions, or as verifyMintQuoteSignature, _n as verifyP2PKSpendingConditions, Si as verifyProofsForReceive, Ht as verifyUnblindedSignature, bt as verifyUnblindedSignatureBls };
