...
var ia = class {
	...
	async getCtfCondition(e, t) {
		...
		let n = e.toLowerCase(), r = await this.getCtfConditionResponse(n, t), i = r, a = this.normalizeCtfCondition(W(i.condition) ? i.condition : r);
	...
	normalizeCtfCondition(e) {
		if (W(e.keysets) || !Array.isArray(e.partitions)) return e;
		let t = {};
		for (let n of e.partitions) if (!(!W(n) || !W(n.keysets))) for (let [e, r] of Object.entries(n.keysets)) typeof r == "string" && (t[e] = r);
		return {
			...e,
			keysets: t
		};
