...
function He(e, t) {
	...
	switch (r) {
		case 0: return We(e, t, i);
		case 1: return Ge(e, t, i);
		case 2: return Ke(e, t, i);
		case 3: return qe(e, t, i);
		case 4: return Je(e, t, i);
		case 5: return Ye(e, t, i);
		case 7: return Ze(e, t, i);
...
function Ke(e, t, n) {
	let { value: r, offset: i } = Ue(e, t, n), a = Number(r);
...
function Je(e, t, n) {
	let { value: r, offset: i } = Ue(e, t, n), a = Number(r), o = [], s = i;
	for (let t = 0; t < a; t++) {
		let t = He(e, s);
...
var $e = (t, r) => {
	...
	return e(c.sign(i, a));
}, et = (e, t) => $e(Qe(e), t), tt = (e, t, r, i = !1) => {
	try {
		let i = Qe(t), a = r.length === 66 ? r.slice(2) : r;
...
var st = "CASHU_BLS12_381_G1_XMD:SHA-256_SSWU_RO_", ct = u.fields.Fr.ORDER, lt = u.G2.Point.BASE, ut = h("Cashu_BLS_Batch_v1"), dt = u.fields.Fr, ft = u.fields.Fp.ORDER;
function N(e) {
	return u.G1.hashToCurve(e, { DST: st });
}
function pt(e, n, r, i) {
...
var Tt = h("Secp256k1_HashToCurve_Cashu_");
function P(t) {
	let n = a(O.concat(Tt, t)), r = new Uint32Array(1), i = 2 ** 16;
	for (let t = 0; t < i; t++) {
...
var zt = (e) => {
	let t;
	return t = /^[a-fA-F0-9]+$/.test(e) ? ei(e) % BigInt(2 ** 31 - 1) : O.toBigInt(ye(e)) % BigInt(2 ** 31 - 1), t;
}, Bt = "m/0'/0'/0'";
function Vt(t) {
	let n = {};
...
function Wt(e, t) {
	...
	let n = P(e.secret), r = l.Point.Fn.fromBytes(t);
...
function Kt(e, t) {
	let n = Array.isArray(e) ? e : [e], r = L(t), i = r[0];
...
function Zt(e, t) {
	return Xt(e).some((e) => e[0] === t);
}
function Qt(e, t) {
	let n = Xt(e).find((e) => e[0] === t);
...
function tn(e, t) {
	...
	return {
		blinded: e.map((e, t) => {
			let r = F(e), i = an(r, n, t), a = r.add(l.Point.BASE.multiply(i));
...
function rn(e, t, n, r) {
	let i = l.Point.CURVE().n, a = typeof e == "string" ? ei(e) : e, o = typeof t == "string" ? ei(t) : t;
...
function an(e, t, n) {
	let r = e.multiply(t).toBytes(!0).slice(1), i = new Uint8Array([n & 255]), o = O.toBigInt(a(O.concat(en, r, i)));
	if ((o === 0n || o >= l.Point.CURVE().n) && (o = O.toBigInt(a(O.concat(en, r, i, new Uint8Array([255])))), o === 0n || o >= l.Point.CURVE().n)) throw new v("P2BK: tweak derivation failed");
	return o;
}
//#endregion
...
var on = {
	...
	SIG_ALL: "SIG_ALL"
}, sn = new Set(Object.values(on)), cn = new Set([
	"locktime",
	"pubkeys",
	"n_sigs",
	"refund",
...
function z(e) {
	let t = Kt(["P2PK", "HTLC"], e);
	Tn(Xt(t));
	let n = $t(t, "sigflag");
	return n !== void 0 && En(n), t;
}
function un(e) {
	let t = e.toLowerCase();
...
function fn(e) {
	let t = z(e), n = Mn(jn(t)), r = kn(t), i = An(t);
	return n === "ACTIVE" || n === "PERMANENT" ? r : n === "EXPIRED" && i.length ? Array.from(new Set([...r, ...i])) : [];
}
function pn(e) {
	return $t(z(e), "sigflag") ?? "SIG_INPUTS";
}
function mn(e) {
	return hn(e)?.signatures ?? [];
}
function hn(e) {
	if (!e) return;
	let t;
...
function _n(t, r, i) {
	let a = z(t.secret);
	i = i ?? t.secret;
	let o = typeof r == "string" ? n(r) : r, s = e(c.getPublicKey(o)), l = fn(a);
	if (!l.length || !l.some((e) => e.includes(s))) throw new v(`Signature not required from [02|03]${s}`);
	if (mn(t.witness).some((e) => tt(e, i, s))) throw new v(`Proof already signed by [02|03]${s}`);
	let u = et(i, r), d = hn(t.witness), f = {
...
function vn(e, t, n) {
	...
	if (wn([t]) && !n) throw new v("Cannot verify a SIG_ALL proof without the message to sign");
	return n = n ?? t.secret, mn(t.witness).some((t) => tt(t, n, e));
}
function yn(e, t = C, n) {
	if (wn([e]) && !n) throw t.error("Cannot verify a SIG_ALL proof without the message to sign"), new v("Cannot verify a SIG_ALL proof without the message to sign");
	n = n ?? e.secret;
	let r = z(e.secret), i = kn(r), a = An(r);
	On({
		mainKeyCount: i.length,
		refundKeyCount: a.length,
		nSigs: R(r, "n_sigs"),
		nSigsRefund: R(r, "n_sigs_refund"),
		hasLocktime: Number.isFinite(jn(r))
	});
	let o = mn(e.witness), s = jn(r), c = Mn(s), l = Nn(r, c, a), u = Pn(r, c, a), d = rt(o, n, i), f = a.length ? rt(o, n, a) : [], p = {
		locktime: s,
		lockState: c,
		main: {
			pubkeys: i,
...
function En(e) {
	if (!sn.has(e)) throw new v(`Invalid sigflag "${e}": must be "SIG_INPUTS" or "SIG_ALL"`);
}
function Dn(e, t) {
...
function On(e) {
	...
	if (r !== void 0 && (Dn(r, "requiredSignatures (n_sigs)"), r > t)) throw new v(`requiredSignatures (n_sigs) (${r}) exceeds available pubkeys (${t})`);
	if (i !== void 0) {
		if (Dn(i, "requiredRefundSignatures (n_sigs_refund)"), n === 0) throw new v("requiredRefundSignatures (n_sigs_refund) requires refund keys");
...
function kn(e) {
	let t = qt(e) === "P2PK" ? Yt(e) : "", n = Qt(e, "pubkeys") ?? [], r = (t ? [t, ...n] : n).map((e) => un(e));
	if (B(r).length !== r.length) throw new v("Duplicate main pubkeys are not allowed");
	return r;
}
function An(e) {
	let t = (Qt(e, "refund") ?? []).map((e) => un(e));
...
function Mn(e, t = Math.floor(Date.now() / 1e3)) {
	return Number.isFinite(e) ? t < e ? "ACTIVE" : "EXPIRED" : "PERMANENT";
}
function Nn(e, t, n) {
	return !n.length && t === "EXPIRED" ? 0 : Math.max(R(e, "n_sigs") ?? 1, 1);
}
function Pn(e, t, n) {
	return n.length && t === "EXPIRED" ? Math.max(R(e, "n_sigs_refund") ?? 1, 1) : 0;
}
function Fn(e, t, n) {
	let r = [];
...
var In = h("Cashu_DLEQ_R_v1"), Ln = BigInt("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141");
function Rn(e, n, r, i) {
	let o = f(In, n.toBytes(!1), r.toBytes(!1), i.toBytes(!1));
	for (let n = 0; n < 256; n++) {
		let r = t(_(a, e, f(o, new Uint8Array([n])))), i = r >= Ln ? r - Ln : r;
		/* c8 ignore next */
		if (i !== 0n) return i;
	}
	/* c8 ignore next */
...
var zn = (e, t, n, r) => {
	...
	let i = P(e), a = n.add(r.multiply(t.r)), o = l.Point.BASE.multiply(t.r);
	return zn(t, i.add(o), a, r);
}, Vn = (e, t) => {
	let n = l.Point.Fn.fromBytes(t), i = l.Point.BASE.multiply(n), a = e.multiply(n), o = Rn(t, i, e, a), s = Et([
...
}, Hn = "m/129372'/0'", Un = BigInt("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141"), Wn = (e, t, n) => Kn(e, t, n).secret, Gn = (e, t, n) => Kn(e, t, n).blindingFactor;
function Kn(e, t, n) {
	return qn(e, t)(n);
}
function qn(e, t) {
...
function Yn(e, t, n) {
	let r = `${Hn}/${zt(t)}'/${n}'`, i = e.derive(r), a = i.deriveChild(0).privateKey, o = i.deriveChild(1).privateKey;
	/* c8 ignore next */
...
function Zn(e, t, n) {
	...
	let i = _(a, e, O.concat(t, O.fromHex("01"))), o = O.toBigInt(i), s = o >= Un ? o - Un : o;
	/* c8 ignore next */
...
function nr(e, t = C, n) {
	let r;
	n = n ?? e.secret;
	let i = L(e.secret), a = yn(e, t, n);
	if (a.path != "MAIN" || qt(i) !== "HTLC") return a;
	let o = ir(e.witness);
	return o ? tr(o, Yt(i)) ? (r = a, t.debug("Spending condition satisfied via hashlock (receiver) pathway", { result: r }), r) : (r = {
		...a,
		success: !1,
		path: "FAILED"
...
}({}), lr = 1, ur = 2, dr = 3, fr = 4, pr = 5, mr = 6, hr = 7, gr = 8, _r = 1, vr = 2, yr = 3, br = 0, xr = 1, Sr = 1, Cr = 2, wr = 3, Tr = 0, Er = 1;
function Dr(e) {
	let t = Or(e), n = {};
	for (let e of t) switch (e.tag) {
		...
		case mr:
			...
			break;
		case hr:
			n.transports || (n.transports = []), n.transports.push(Pr(e.value));
			break;
		case gr:
			n.nut10 || (n.nut10 = []), n.nut10.push(Fr(e.value));
			break;
		default: break;
	}
	return n;
...
function Lr(e) {
	let t = [];
	if (e.id && t.push(H(lr, Rr(e.id))), e.amount !== void 0 && t.push(H(ur, zr(e.amount))), e.unit && (e.unit === "sat" ? t.push(H(dr, new Uint8Array([0]))) : t.push(H(dr, Rr(e.unit)))), e.singleUse !== void 0 && t.push(H(fr, Br(+!!e.singleUse))), e.mints && e.mints.length > 0) for (let n of e.mints) t.push(H(pr, Rr(n)));
	if (e.description && t.push(H(mr, Rr(e.description))), e.transports && e.transports.length > 0) for (let n of e.transports) t.push(H(hr, Ur(n)));
	if (e.nut10 && e.nut10.length > 0) for (let n of e.nut10) t.push(H(gr, Wr(n)));
...
function Vr(e) {
	switch (e) {
		case cr.NOSTR: return br;
		case cr.POST: return xr;
...
function Ur(e) {
	...
	let r, i = [];
	if (e.type === cr.NOSTR) {
		let { pubkey: t, relays: n } = Kr(e.target);
		r = t, i = n.map((e) => ["r", e]);
	} else r = Rr(e.target);
	t.push(H(vr, r));
	let a = [...i, ...e.tags || []];
	if (a.length > 0) for (let e of a) t.push(H(yr, Gr(e)));
...
function Wr(e) {
	let t = [], n = Hr(e.kind);
	if (t.push(H(Sr, Br(n))), t.push(H(Cr, Rr(e.data))), e.tags && e.tags.length > 0) for (let n of e.tags) t.push(H(wr, Gr(n)));
...
function U(e, t, n, r) {
	let i = $r(e, "splitAmount.value", !0), a = n?.map((e) => $r(e, "splitAmount.split", !0));
	if (a) {
		let e = A.sum(a);
		...
		if (n.some((e) => !Qr(e, t))) throw new v("Provided amount preferences do not match the amounts of the mint keyset.");
...
function Qr(e, t) {
	return $r(e, "hasCorrespondingKey.amount", !0).toString() in t;
}
function $r(e, t, n = !1) {
	let r = A.from(e);
...
function ai(e, t) {
	let n = J(e.proofs);
	if (ni(n)) throw new v("Proofs contain a legacy keyset ID and cannot be encoded. Swap them at the mint first.");
	return oi({
		...e,
		proofs: n
	}, t?.removeDleq);
...
function oi(e, t) {
	let n = e.proofs;
	if (t && (n = bi(n)), n.forEach((e) => {
		if (e.dleq && e.dleq.r == null) throw new v("Missing blinding factor in included DLEQ proof");
	}), ni(n)) throw new v("can not encode to v4 token if proofs contain non-hex keyset id");
	return n = ii(n), "cashuB" + _e(ke(si({
		...e,
		proofs: n
	})));
}
...
function li(e, t) {
	let n = di(Ei(e));
	return n.proofs = xi(n.proofs, t), n;
}
function ui(e) {
	e = Ei(e);
	let t = di(e);
...
function fi(e, t) {
	...
	switch (o) {
		case 0: {
			let t = a(pi(...Object.entries(e).sort(([e], [t]) => A.from(e).compareTo(t)).map(([, e]) => n(e))));
...
function vi(e) {
	...
	return J(e.map((e) => typeof e == "string" ? j.parse(e) : e));
}
function yi(e) {
	return Yr.fromEncodedRequest(e);
}
function bi(e) {
	return e.map((e) => {
		let { dleq: t, ...n } = e;
...
function Si(e, t, r) {
	let i = r?.require ?? !1;
	if (!Qr(e.amount, t.keys)) throw new v(`Undefined key for amount ${e.amount.toString()} in keyset ${t.id}`);
	if (I(e.id)) try {
	...
	try {
		...
		return Bn(new TextEncoder().encode(e.secret), t, F(e.C), F(a));
	} catch {
		return !1;
	}
}
function Ci(e, t, n) {
	...
	for (let e of s) if (!Si(e, t(e.id), { require: i })) throw new v(a + c(e));
	if (o.length === 0) return;
	let l = o.map((e) => {
		let n = t(e.id);
		if (!Qr(e.amount, n.keys)) throw new v(`Undefined key for amount ${e.amount.toString()} in keyset ${n.id}`);
		let r, i;
		try {
...
function wi(e) {
	let t = new TextEncoder(), n = J(e.proofs), r = ke(si({
		...e,
		proofs: n
	}));
	return pi(t.encode("craw"), t.encode("B"), r);
}
function Ti(e) {
...
var Ai = class e {
	...
	static normalizeSwapMethods(e) {
		return e.map((e) => {
			let t = { ...e };
			return hi(t, "min_amount", "max_amount"), t;
		});
	}
...
var Fi = Pi(globalThis);
function Ii(e, t, n = Fi) {
	return {
...
var Hi = 9, Ui = 1e3, Wi = 100, Gi = class e extends b {
	constructor(t) {
		super(t), this.name = "CallerAbortError", Object.setPrototypeOf(this, e.prototype);
	}
};
function Ki(e) {
	return e instanceof Gi ? !1 : e instanceof b ? !0 : e instanceof y && e.status >= 500;
}
function qi(e, t) {
	return t ? new Promise((n, r) => {
		if (t.aborted) {
			r(new Gi("Request aborted by caller"));
			return;
		}
		let i = () => {
			clearTimeout(a), t.removeEventListener("abort", i), r(new Gi("Request aborted by caller"));
		};
...
async function Xi(e) {
	let { ttl: t, cached_endpoints: n, endpoint: r } = e, i = Ji(r), a = e.method?.toUpperCase() ?? "GET";
	if (!(i !== void 0 && n?.some((e) => Yi(i, e.path) && e.method === a) && t)) return await Zi(e);
	let o = 0, s = Date.now(), c = async () => {
		try {
			...
			if (Ki(n)) {
				let r = Date.now() - s;
				if (o < Hi && (!t || r < t)) {
					let i = Math.min(2 ** o * Wi, Ui), a = Math.random() * i;
...
async function Zi(e) {
	let { endpoint: t, requestBody: n, headers: r, requestTimeout: i, responseBodyBytesLimit: a, onResponseMeta: o, cached_endpoints: s, ttl: c, logger: l, ...u } = e, d = n ? j.stringify(n) : void 0, f = Ii(d, r), p = e.signal ?? void 0;
	if (p?.aborted) throw new Gi("Request aborted by caller");
	let m = i === void 0 ? void 0 : new AbortController(), h = p, g, _;
	if (m) if (g = setTimeout(() => m.abort(), i), !p) h = m.signal;
	else {
		let e = new AbortController(), t = () => e.abort();
		p.addEventListener("abort", t, { once: !0 }), m.signal.addEventListener("abort", t, { once: !0 }), _ = () => {
			p.removeEventListener("abort", t), m.signal.removeEventListener("abort", t);
		}, h = e.signal;
	}
	let v;
	try {
		...
		throw clearTimeout(g), _?.(), Qi(e, m, p, i);
	}
	try {
		return await $i(v, {
			endpoint: t,
			onResponseMeta: o,
			responseBodyBytesLimit: a
		});
	} catch (e) {
		throw m?.signal.aborted || p?.aborted ? Qi(e, m, p, i) : e;
	} finally {
		clearTimeout(g), _?.();
	}
}
function Qi(e, t, n, r) {
	return t?.signal.aborted ? new b(`Request timed out after ${r}ms`, { cause: e }) : n?.aborted ? new Gi(Li(e, "Request aborted by caller")) : e instanceof Error && (e.name === "AbortError" || e.name === "TimeoutError") ? new b(e.message, { cause: e }) : new b(Li(e, "Network request failed"), { cause: e });
}
async function $i(e, t) {
	let n = Ri(e.headers.get("Retry-After"));
	return ea(e, t.endpoint, n, t.onResponseMeta), e.ok ? na(e, t.responseBodyBytesLimit) : ta(e, n, t.responseBodyBytesLimit);
}
function ea(e, t, n, r) {
	!r || !e.headers || E(r, {
		endpoint: t,
...
async function ta(e, t, n) {
	...
	try {
		...
		i = e, r = { error: "bad response" };
	}
	throw e.status === 429 ? new x("429 Too Many Requests", t) : e.status === 400 && typeof r.code == "number" && typeof r.detail == "string" ? new S(r.code, r.detail) : new y(typeof r.error == "string" ? r.error : typeof r.detail == "string" ? r.detail : "HTTP request failed", e.status, { cause: i });
}
async function na(e, t) {
	try {
		let n = await ra(e, t);
		if (!n) throw new v("Empty response body");
		return j.parse(n);
	} catch (t) {
		throw Z.error("Failed to parse HTTP response", { err: t }), new y("bad response", e.status, { cause: t });
	}
}
async function ra(e, t) {
	if (t === void 0) return e.text();
	if (!Number.isSafeInteger(t) || t < 1) throw new v("Response body byte limit is invalid");
	let n = e.headers.get("Content-Length");
	if (n !== null && /^\d+$/.test(n) && Number(n) > t) throw e.body?.cancel().catch(() => void 0), new v("Response body exceeds configured byte limit");
	if (!e.body) {
		let n = await e.text();
		if (new TextEncoder().encode(n).byteLength > t) throw new v("Response body exceeds configured byte limit");
		return n;
	}
	return ia(e.body, t);
}
async function ia(e, t) {
	...
	try {
		for (;;) {
			...
			if (e) break;
			if (a += o.byteLength, a > t) throw n.cancel().catch(() => void 0), new v("Response body exceeds configured byte limit");
			i.push(r.decode(o, { stream: !0 }));
		}
		return i.push(r.decode()), i.join("");
	} finally {
		n.releaseLock();
	}
}
...
async function oa(e) {
	let t = e.onResponseMeta, n = zi.onResponseMeta, r = {
		...e,
		...zi
	};
	return r.requestTimeout = sa(e.requestTimeout, zi.requestTimeout), r.responseBodyBytesLimit = ca(e.responseBodyBytesLimit, zi.responseBodyBytesLimit), r.signal = e.signal ?? zi.signal, t && (r.onResponseMeta = t), t && n && t !== n && (r.onResponseMeta = (r) => {
		E(t, r, Z, {
			op: "request.onResponseMeta",
			scope: "per-request",
			endpoint: e.endpoint
...
var la;
typeof WebSocket < "u" && (la = WebSocket);
function ua(e) {
	la = e;
}
function da() {
	if (la === void 0) throw new v("WebSocket implementation not initialized");
	return la;
}
//#endregion
...
var fa = class {
	...
	constructor(e, t) {
		this.subListeners = {}, this.rpcListeners = {}, this.rpcId = 0, this.onCloseCallbacks = [], this._WS = da(), this.url = new URL(e), this.messageQueue = new pa(), this._logger = t ?? C;
	}
	setLogger(e) {
		this._logger = e;
	}
	...
	constructor(e, t) {
		...
		}, this._mintUrl = gi(e), this._request = t?.customRequest ?? oa, this._authProvider = t?.authProvider, this._logger = t?.logger ?? C, Vi(this._logger);
	}
	get mintUrl() {
	...
	async check(e, t) {
		...
		for (let e of n.states) hi(e, "witness");
		return n;
	}
	async getKeys(e, t, n) {
	...
	async getConditionalKeysets(e = {}, t) {
		...
		let r = n.toString(), i = r ? `/v1/conditional_keysets?${r}` : "/v1/conditional_keysets", a = await this.requestWithAuth("GET", i, { responseBodyBytesLimit: 16 * 1024 * 1024 }, t), o = (e) => {
			...
			if (e != null) {
				...
				try {
					return Y(e, `conditional_keyset.${t}`, void 0);
				} catch {
					return o(`${t} must be a safe non-negative integer when present`);
				}
			}
		};
		if (!G(a)) return o("response must be an object");
		let l = a;
		...
		let u = {
			keysets: l.keysets.map((e) => {
				if (!G(e)) return o("keyset entries must be objects");
				let t = e;
	...
	async connectWebSocket() {
		try {
			...
			let t = e.toString();
			this.ws || (this.ws = new ma(t, this._logger)), await this.ws.ensureConnection();
		} catch (e) {
	...
	normalizeMintQuoteBolt11Fields(e) {
		e.amount = A.from(e.amount), e.expiry = Y(e.expiry, "mintQuoteBolt11.expiry", null);
	}
	normalizeMintQuoteBolt12Fields(e) {
		hi(e, "amount"), e.amount = e.amount === null ? null : A.from(e.amount), e.expiry = Y(e.expiry, "mintQuoteBolt12.expiry", null), e.amount_paid = A.from(e.amount_paid), e.amount_issued = A.from(e.amount_issued);
	}
	normalizeMintQuoteOnchainFields(e) {
		e.expiry = Y(e.expiry, "mintQuoteOnchain.expiry", null), e.amount_paid = A.from(e.amount_paid), e.amount_issued = A.from(e.amount_issued);
	}
	...
	normalizeMeltBaseFields(e, t) {
		if (e.amount = A.from(e.amount), e.expiry = Y(e.expiry, "meltQuote.expiry", void 0), e.change && (e.change = this.normalizeSignatureAmounts(e.change)), !G(e) || typeof e.quote != "string" || !(e.amount instanceof A) || typeof e.unit != "string" || typeof e.state != "string" || typeof e.expiry != "number" || !Object.values(Mi).includes(e.state)) throw this._logger.error("Invalid response from mint...", {
			data: e,
			op: t
		}), new v("Invalid response from mint");
	}
	...
	normalizeMeltOnchainFields(e) {
		...
		}), hi(e, "selected_fee_index", "outpoint"), typeof e.request != "string" || e.selected_fee_index !== null && !Number.isSafeInteger(e.selected_fee_index) || e.outpoint !== null && typeof e.outpoint != "string")) throw this._logger.error("Invalid response from mint...", {
			data: e,
			op: "onchain melt quote"
		}), Error("Invalid response from mint");
	}
	...
	static verifyKeysetId(e) {
		try {
			...
			let t = Se(e.id) && !W(e.id), r = W(e.id) ? n(e.id)[0] : 0;
			return fi(e.keys, {
	...
	static verifyConditionalKeysetId(e, t) {
		try {
			return !e.keys || Object.keys(e.keys).length === 0 ? !1 : at({
				keys: e.keys,
				input_fee_ppk: e.input_fee_ppk,
	...
	static fromMintApi(t, n) {
		let r = Oi(t), i = n ? ki(n) : void 0, a = new e(r.id, r.unit, r.active, r.input_fee_ppk, r.final_expiry, r.conditional);
		if (i) {
	...
	constructor(e, t) {
		this.keysets = {}, this.pendingKeyFetches = /* @__PURE__ */ new Map(), this.mint = typeof e == "string" ? new ha(e) : e, this.unit = t;
	}
	...
	buildKeychain(e, t) {
		...
		for (let t of e) {
			let e = n.get(t.id), r = e ? ga.fromMintApi(t, e) : ga.fromMintApi(t);
	...
	async ensureKeysetKeys(e) {
		...
		let r = (async () => {
			...
			let r = t.toMintKeyset(), i = ga.fromMintApi(r, n);
	...
	registerConditionalKeyset(e, t) {
		let n = t ? ga.fromMintApi(e, t) : ga.fromMintApi(e);
...
}, ya = 1024, ba = "Inputs may already be spent; if the wallet is seeded, try restoring (NUT-09) to recover.", xa = new Set([
	"locktime",
	"pubkeys",
	"n_sigs",
	"refund",
...
function Sa(e) {
	...
	if (xa.has(e)) throw new v(`additionalTags must not use reserved key "${e}"`);
}
var Q = class e {
	constructor(e, t, n, r) {
	...
	toProof(e, t) {
		if (e == null) throw new v(`Mint response is missing a signature for one of the outputs. ${ba}`);
		...
		if (!n.isZero() && !e.amount.equals(n)) throw new v(`Mint signature amount ${e.amount.toString()} does not match requested amount ${n.toString()}. ${ba}`);
		if (I(e.id)) {
			let n, r;
			try {
				...
				throw new v(`Mint returned invalid signature or amount. ${ba}`, { cause: e });
			}
			let i = bt({
				id: e.id,
				C_: n
		...
		if (e.dleq && (a = {
			...
			if (e.kind === "secp" && !zn(a, e.pt, i, r)) throw new v("DLEQ verification failed on mint response");
		}
		let o = Pt({
			id: e.id,
			C_: i
	...
	static createSingleP2PKData(t, n, r) {
		let i = A.from(n), a = dn(t), o = Array.isArray(a.pubkey) ? a.pubkey : [a.pubkey], s = a.refundKeys ?? [], c = a.requiredSignatures ?? 1, l = a.requiredRefundSignatures ?? 1, u = a.hashlock, f = typeof u == "string" && u.length > 0, p = f ? u : o[0], h = f ? o : o.slice(1), g = s, _;
		if (t.blindKeys) {
			let { blinded: e, Ehex: t } = tn([...o, ...s]);
		...
		if (Number.isSafeInteger(b) && b >= 0 && y.push(["locktime", String(b)]), h.length > 0 && (y.push(["pubkeys", ...h]), c > 1 && y.push(["n_sigs", String(c)])), g.length > 0 && (y.push(["refund", ...g]), l > 1 && y.push(["n_sigs_refund", String(l)])), a.sigFlag == "SIG_ALL" && y.push(["sigflag", "SIG_ALL"]), a.additionalTags?.length) {
			let e = a.additionalTags.map(([e, ...t]) => (Sa(e), [e, ...t.map(String)]));
			y.push(...e);
		}
		let x = [f ? "HTLC" : "P2PK", {
			nonce: d(m(32)),
		...
		if (C > 1024) throw new v(`Secret too long (${C} characters), maximum is ${ya}`);
		let w = new TextEncoder().encode(S), { r: T, B_: ee } = Ea(w, r);
		return new e(new va(i, ee, r).getSerializedBlindedMessage(), T, w, _);
	}
	...
	static createSingleRandomData(t, n) {
		let r = A.from(t), i = d(m(32)), a = new TextEncoder().encode(i), { r: o, B_: s } = Ea(a, n);
		return new e(new va(r, s, n).getSerializedBlindedMessage(), o, a);
	}
	static createDeterministicData(e, t, n, r, i) {
		let a = U(e, r.keys, i), o = qn(t, r.id);
		return a.map((e, t) => Ca(e, r.id, n + t, o(n + t)));
	}
	static createSingleDeterministicData(e, t, n, r) {
		return Ca(e, r, n, Kn(t, r, n));
	}
	...
	static serialize(e) {
		return {
			...
			...e.nut13 !== void 0 && { nut13: Ta(e.nut13, e.blindedMessage.id) }
		};
	}
	static deserialize(t) {
		try {
			...
			return t.nut13 === void 0 ? n : wa(n, t.nut13);
		} catch (e) {
...
function Ca(e, t, n, r) {
	let i = A.from(e), a = d(r.secret), o = new TextEncoder().encode(a), { r: s, B_: c } = Ea(o, t, O.toBigInt(r.blindingFactor));
	return wa(new Q(new va(i, c, t).getSerializedBlindedMessage(), s, o), {
		keysetId: t,
		counter: n
	});
}
function wa(e, t) {
	return Object.defineProperty(e, "nut13", {
		configurable: !1,
		enumerable: !0,
		value: Ta(t, e.blindedMessage.id),
		writable: !1
	}), e;
}
function Ta(e, t) {
...
var Oa = class e {
	...
	lockUntil(e) {
		return this.locktime = Da(e), this;
	}
...
function ka(e, t, n, r = !1, i = !1, a = C) {
	let o = J(e), s = A.from(t), c = s.toNumber(), l = ne(), u = null, d = Infinity, f = 0, p = 0, m = (e) => {
		try {
...
var Aa = class e {
	...
	createDeterministicData(t, n, r, i, a) {
		return this.createSingleDeterministicData === e.prototype.createSingleDeterministicData ? Q.createDeterministicData(t, n, r, i, a) : U(t, i.keys, a).map((e, t) => this.createSingleDeterministicData(e, n, r + t, i.id));
	}
...
function Ra(e) {
	return e instanceof Error ? e : new v(typeof e == "string" ? e : La(e), { cause: e });
}
function za() {
...
var Ba = class {
	...
	waitUntilPaid(e, t, n, r = "Timeout waiting for paid") {
		return new Promise((i, a) => {
			let o = null, s = null, c = !1, l = (e) => {
				c || (c = !0, $(o), s && (clearTimeout(s), s = null), n?.signal && n.signal.removeEventListener("abort", u), e && a(Ra(e)));
			}, u = () => l(za());
			if (n?.signal) {
	...
	async proofStateUpdates(e, t, n, r) {
		...
		for (let t of e) {
			let e = I(t.id) ? N(a.encode(t.secret)).toHex(!0) : P(a.encode(t.secret)).toHex(!0);
		...
		return new Promise((n, r) => {
			let i = Array.from(new Set(e)), a = /* @__PURE__ */ new Map(), o = null, s = null, c = !1, l = !1, u = (e) => {
				if (!l) {
					...
					a.clear(), o && (clearTimeout(o), o = null), t?.signal && t.signal.removeEventListener("abort", d), e && r(Ra(e));
				}
			}, d = () => u(za());
			if (t?.signal) {
	...
	send(e, t) {
		return new Ha(this.wallet, e, t);
	}
	receive(e) {
		return new Ua(this.wallet, e);
	}
	mintBolt11(e, t) {
		return new Wa(this.wallet, "bolt11", e, t);
	}
	mintBolt12(e, t) {
		return new Wa(this.wallet, "bolt12", e, t);
	}
	mintOnchain(e, t) {
		return new Wa(this.wallet, "onchain", e, t);
	}
	meltBolt11(e, t) {
		return new Ga(this.wallet, "bolt11", e, t);
	}
	meltBolt12(e, t) {
		return new Ga(this.wallet, "bolt12", e, t);
	}
	meltOnchain(e, t) {
		return new Ka(this.wallet, e, t);
	}
}, Ha = class {
	constructor(e, t, n) {
...
var Ja = "__PENDING__", Ya = class e {
	constructor(e, t) {
		this._seed = void 0, this._unit = "sat", this._mintInfo = void 0, this._denominationTarget = 3, this._secretsPolicy = "auto", this._boundKeysetId = Ja, this._requireSigDleq = !1, this.ops = new Va(this), this.on = new Ba(this), this._logger = t?.logger ?? C, this._selectProofs = t?.selectProofs ?? ka, this._outputDataCreator = t?.outputDataCreator ?? new Aa(), this.mint = typeof e == "string" ? new ha(e, {
			authProvider: t?.authProvider,
			logger: this._logger
		}) : e, this._unit = t?.unit ?? this._unit, this._boundKeysetId = t?.keysetId ?? this._boundKeysetId, t?.bip39seed && (this.failIf(!(t.bip39seed instanceof Uint8Array), "bip39seed must be a valid Uint8Array", { bip39seed: t.bip39seed }), this._seed = t.bip39seed), this._secretsPolicy = t?.secretsPolicy ?? this._secretsPolicy, t?.counterSource ? this._counterSource = t.counterSource : this._counterSource = new Pa(t?.counterInit), this.counters = new Ia(this._counterSource), this._keyChain = new _a(this.mint, this._unit), this._denominationTarget = t?.denominationTarget ?? this._denominationTarget, this._requireSigDleq = t?.requireSigDleq ?? this._requireSigDleq, this.ctf = t?.enableCtf ? this.createCtfFacade() : void 0;
	}
	createCtfFacade() {
		return {
	...
	async loadMint(e, t) {
		let n = qa(this.mint, t), r = [];
		(!this._mintInfo || e) && r.push(this.mint.getInfo(n).then((e) => (this._mintInfo = new X(e, this._logger), this.mint.setMintInfo(this._mintInfo), null))), r.push(this._keyChain.init(e, n)), await Promise.all(r), this.finishInit();
	}
	...
	finishInit() {
		if (this._logger.debug("KeyChain", { keychain: this._keyChain.cache }), this._boundKeysetId === Ja) try {
	...
	get keysetId() {
		return this.failIf(this._boundKeysetId === Ja, "Wallet has no bound keyset. The mint may have no active keysets, or wallet was not initialized via loadMint or loadMintFromCache"), this._boundKeysetId;
	}
	getKeyset(e) {
	...
	configureOutputs(e, t, n, r = !1, i = []) {
		...
		if (s.length === 0 && o.length > 0 && (s = Ma(o, a, t.keys, this._denominationTarget)), s = U(a, t.keys, s), r) {
	...
	createSwapTransaction(e, t, n = []) {
		...
		wn(e) || i.sort((e, t) => r[e].blindedMessage.amount.compareTo(r[t].blindedMessage.amount));
	...
	async prepareSwapToReceive(e, t, n) {
		...
		if (Array.isArray(e)) s = J(e);
			...
			let t = typeof e == "string" ? this.decodeToken(e) : e, n = gi(t.mint);
		...
		this.failIf(u.isZero(), "Token contains no proofs", { proofs: s }), Ci(s, (e) => this._keyChain.getKeyset(e), { requireDleq: i });
	...
	sendOffline(e, t, n) {
		...
		a && (i = i.filter((e) => I(e.id) || e.dleq != null)), this.failIf(q(i).lessThan(r), "Not enough funds available to send");
	...
	async prepareConditionalSwap(e) {
		...
		}), c = A.from(Math.ceil(t.length * i.fee / 1e3)), l = q(t).subtract(c);
	...
	signP2PKProofs(e, t, n, r) {
		let i = J(e);
		if (!wn(i)) return gn(i, t, this._logger);
		this.failIfNullish(n, "OutputData is required for SIG_ALL proof signing."), Sn(i);
		let [a, ...o] = i, s = a, c = [Fn(i, n, r), Cn(i, n, r)];
		for (let e of c) s = gn([s], t, this._logger, e)[0];
		return [s, ...o];
	}
	getFeesForProofs(e) {
	...
	decodeToken(e) {
		return li(e, this._keyChain.getAllKeysetIds());
	}
	...
	async prepareMint(e, t, n, r, i) {
		...
		if ("pubkey" in n && n.pubkey && this.failIf(!o, "Can not sign locked quote without private key"), o) {
			...
			this.failIf(!t, "prepareMint: privkey is empty or correct privkey not provided"), g.signature = or(t, n.quote, h);
		}
		return {
			method: e,
			payload: g,
	...
	async prepareBatchMint(e, t, n, r) {
		...
		for (let e of t) {
			...
			if (t && s) {
				let n = nt(t, s);
				v.push(or(n, e.quote.quote, _)), y = !0;
	...
	async createMeltQuoteBolt11(e, t) {
		...
		t !== void 0 && this.failIf(Di(e), "amountMsat supplied but invoice already contains an amount. Leave amountMsat undefined for non-zero invoices.");
	...
	async checkProofsStates(e, t) {
		let n = new TextEncoder(), r = e.map((e) => I(e.id) ? N(n.encode(e.secret)).toHex(!0) : P(n.encode(e.secret)).toHex(!0)), i = [];
		for (let e = 0; e < r.length; e += 100) {
			let n = r.slice(e, e + 100), { states: a } = await this.mint.check({ Ys: n }, qa(this.mint, t)), o = {};
			a.forEach((e) => {
				o[e.Y] = e;
			});
			for (let e = 0; e < n.length; e++) {
				let t = o[n[e]];
				this.failIfNullish(t, "Could not find state for proof with Y: " + n[e]), i.push(t);
			}
		}
		return i;
	}
	...
	constructor(e, t) {
		this.tokens = {}, this.pool = [], this.desiredPoolSize = 100, this.maxPerMint = 100, this.mintUrl = e, this.req = t?.request ?? oa, this.logger = t?.logger ?? C;
	...
	async init() {
		...
		if (!this.keychain) {
			let [e, t] = await Promise.all([this.req({
				...
				method: "GET"
			})]), n = e.keysets.map((e) => Oi(e)), r = t.keysets.map((e) => ki(e)), i = _a.mintToCacheDTO(this.mintUrl, n, r);
			this.keychain = _a.fromCache(this.mintUrl, "auth", i), this.keychain.getCheapestKeyset();
		}
	}
	getBatMaxMint() {
...
var eo = "sigallA";
function to(e, t, n) {
	let r = t.map((e) => ({ blindedMessage: e })), i = Fn(e, r, n), a = Cn(e, r, n);
	return {
		legacy: Qe(i, !0),
		current: Qe(a, !0)
	};
...
function no(e) {
	...
	let n = j.stringify(t) ?? "{}";
	return `${eo}${_e(O.fromString(n))}`;
}
function ro(e, t) {
	if (!e.startsWith(eo)) throw new v(`Invalid signing package: must start with "${eo}"`);
	let n = e.slice(7), r;
	try {
	...
	let a = i, o = a.version;
	if (o !== eo) throw new v(`Invalid signing package version: ${o}`);
	let s = a.type;
	...
	if (t?.validateDigest) {
		let e = to(a.inputs, a.outputs, a.quote);
...
function io(e, t) {
	...
	if (n.push($e(e.digests.current, t)), e.digests.legacy && n.push($e(e.digests.legacy, t)), n.length === 0) throw new v("No signatures produced during signing");
	return {
		...e,
...
function ao(e) {
	...
	return so("swap", e.inputs, t.map((e) => e.blindedMessage));
}
function oo(e) {
	return so("melt", e.inputs, e.outputData.map((e) => e.blindedMessage), e.quote.quote);
}
function so(e, t, n, r) {
	let i = to(t, n, r), a = Qe(Cn(t, n.map((e) => ({ blindedMessage: e })), r), !0);
...
function uo(e, t) {
	...
	let [n, ...r] = e, i = hn(n.witness), a = i?.signatures ?? [];
	return [{
		...n,
		witness: {
			...i ?? {},
...
var fo = {
	computeDigests: to,
	extractSwapPackage: ao,
	extractMeltPackage: oo,
	serializePackage: no,
	deserializePackage: ro,
	signPackage: io,
	signDigest: $e,
	mergeSwapPackage: co,
	mergeMeltPackage: lo
...
//#endregion
export { A as Amount, k as AmountError, ae as AmountWithUnit, ie as AmountWithUnitError, Za as AuthManager, ct as BLS_FR_ORDER, lt as BLS_G2_GENERATOR, st as BLS_HASH_TO_CURVE_DST, v as CTSError, ha as CashuMint, ha as Mint, Ya as CashuWallet, Ya as Wallet, Ni as CheckStateEnum, te as ConsoleLogger, y as HttpResponseError, j as JSONInt, _a as KeyChain, ga as Keyset, Ga as MeltBuilder, Ka as MeltOnchainBuilder, Mi as MeltQuoteState, Wa as MintBuilder, X as MintInfo, S as MintOperationError, ji as MintQuoteState, b as NetworkError, Ai as OIDCAuth, Q as OutputData, en as P2BK_DST, Oa as P2PKBuilder, Yr as PaymentRequest, cr as PaymentRequestTransportType, x as RateLimitError, Ua as ReceiveBuilder, Ha as SendBuilder, fo as SigAll, on as SigFlags, ma as WSConnection, Ia as WalletCounters, Ba as WalletEvents, Va as WalletOps, It as asBlsG1Point, Ft as asSecpPoint, Kt as assertSecretKind, Sn as assertSigAllInputs, wt as batchVerifyUnblindedSignatureBls, ri as bigIntStringify, Mt as blindMessage, vt as blindMessageBls, Fn as buildLegacyP2PKSigAllMessage, Cn as buildP2PKSigAllMessage, Qe as computeMessageDigest, Pt as constructUnblindedSignature, bt as constructUnblindedSignatureBls, $a as createAuthWallet, At as createBlindSignature, xt as createBlindSignatureBls, Vn as createDLEQProof, Fa as createEphemeralCounterSource, er as createHTLCHash, Qn as createHTLCsecret, Ut as createNewMintKeys, ln as createP2PKsecret, jt as createRandomRawBlindedMessage, kt as createRandomSecretKey, Gt as createSecret, qn as createSecretAndBlindingFactorDeriver, yi as decodePaymentRequest, B as dedupeP2PKPubkeys, Ct as deriveBatchWeights, Gn as deriveBlindingFactor, at as deriveConditionalKeysetId, fi as deriveKeysetId, tn as deriveP2BKBlindedPubkeys, rn as deriveP2BKSecretKey, nn as deriveP2BKSecretKeys, Wn as deriveSecret, Kn as deriveSecretAndBlindingFactor, Ht as deserializeMintKeys, vi as deserializeProofs, nt as findSigningKey, Yt as getDataField, li as getDecodedToken, Ti as getDecodedTokenBinary, ai as getEncodedToken, ai as getEncodedTokenV4, wi as getEncodedTokenBinary, gt as getG2PubKeyFromPrivKey, ir as getHTLCWitnessPreimage, Xr as getKeysetAmounts, zt as getKeysetIdInt, fn as getP2PKExpectedWitnessPubkeys, pn as getP2PKSigFlag, mn as getP2PKWitnessSignatures, Ot as getPubKeyFromPrivKey, Jt as getSecretData, qt as getSecretKind, Qt as getTag, R as getTagInt, $t as getTagScalar, Xt as getTags, ui as getTokenMetadata, rt as getValidSigners, Qr as hasCorrespondingKey, vn as hasP2PKSignedProof, Zt as hasTag, Si as hasValidDleq, P as hashToCurve, N as hashToCurveBls, Et as hash_e, ei as hexToNumber, ua as injectWebSocketImpl, Di as invoiceHasAmountInHRP, I as isBlsKeyset, rr as isHTLCSpendAuthorised, G as isObj, wn as isP2PKSigAll, bn as isP2PKSpendAuthorised, W as isValidHex, K as joinUrls, xn as maybeDeriveP2BKPrivateKeys, it as meetsSignerThreshold, dn as normalizeP2PKOptions, J as normalizeProofAmounts, gi as normalizeUrl, hi as nullIfUndefined, ti as numberToHexPadded64, $n as parseHTLCSecret, z as parseP2PKSecret, L as parseSecret, hn as parseWitnessData, Dt as pointFromBytes, F as pointFromHex, Lt as pointFromHexAuto, mt as pointFromHexG1, ht as pointFromHexG2, Rt as pointToHex, $e as schnorrSignDigest, et as schnorrSignMessage, tt as schnorrVerifyMessage, ka as selectProofsRGLI, Vt as serializeMintKeys, _i as serializeProofs, Bi as setGlobalRequestOptions, or as signMintQuote, _n as signP2PKProof, gn as signP2PKProofs, mi as sortProofsById, U as splitAmount, bi as stripDleq, q as sumProofs, Nt as unblindSignature, yt as unblindSignatureBls, zn as verifyDLEQProof, Bn as verifyDLEQProof_reblind, tr as verifyHTLCHash, nr as verifyHTLCSpendingConditions, sr as verifyMintQuoteSignature, yn as verifyP2PKSpendingConditions, Ci as verifyProofsForReceive, Wt as verifyUnblindedSignature, St as verifyUnblindedSignatureBls };
