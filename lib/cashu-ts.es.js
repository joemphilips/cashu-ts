...
function tt(e, t, n) {
	return Array.from(new Set(n)).filter((n) => e.some((e) => $e(e, t, n)));
}
var nt = (e, t, n, r = 1) => tt(e, t, n).length >= r;
//#endregion
//#region src/crypto/CTF.ts
function rt(e) {
	if (it(e.conditionId, "conditionId"), it(e.outcomeCollectionId, "outcomeCollectionId"), !e.unit) throw new v("Cannot compute conditional keyset ID: unit is required.");
...
var at = "CASHU_BLS12_381_G1_XMD:SHA-256_SSWU_RO_", ot = u.fields.Fr.ORDER, st = u.G2.Point.BASE, ct = h("Cashu_BLS_Batch_v1"), lt = u.fields.Fr, ut = u.fields.Fp.ORDER;
function F(e) {
...
function St(t) {
	...
	for (let n = 0; n < t.length; n++) {
		let i = F(t[n].secret).multiply(r[n]), o = e(t[n].K2.toBytes(!0)), s = a.get(o);
...
function I(t) {
	...
	for (let t = 0; t < i; t++) {
		...
		try {
			return L(e(O.concat(new Uint8Array([2]), i)));
		} catch {
			r[0]++;
		}
	}
...
function Ht(e, t) {
	if (R(e.id)) {
		...
		return F(e.secret).multiply(n).equals(e.C);
	}
	let n = I(e.secret), r = l.Point.Fn.fromBytes(t);
...
function Gt(e, t) {
	let n = Array.isArray(e) ? e : [e], r = Wt(t), i = r[0];
...
function Xt(e, t) {
	return Yt(e).some((e) => e[0] === t);
}
function Zt(e, t) {
	let n = Yt(e).find((e) => e[0] === t);
...
function tn(e, t) {
	...
	return {
		blinded: e.map((e, t) => {
			let r = L(e), i = an(r, n, t), a = r.add(l.Point.BASE.multiply(i));
...
function pn(e) {
	return Qt(z(e), "sigflag") ?? "SIG_INPUTS";
}
function mn(e) {
...
function _n(t, r, i) {
	...
	if (mn(t.witness).some((e) => $e(e, i, s))) throw new v(`Proof already signed by [02|03]${s}`);
	let u = Qe(i, r), d = hn(t.witness), f = {
...
function vn(e, t, n) {
	...
	return n = n ?? t.secret, mn(t.witness).some((t) => $e(t, n, e));
}
function yn(e, t = C, n) {
	...
	On({
		...
		nSigs: $t(r, "n_sigs"),
		nSigsRefund: $t(r, "n_sigs_refund"),
		hasLocktime: Number.isFinite(jn(r))
	});
	let o = mn(e.witness), s = jn(r), c = Mn(s), l = Nn(r, c, a), u = Pn(r, c, a), d = tt(o, n, i), f = a.length ? tt(o, n, a) : [], p = {
		locktime: s,
		lockState: c,
		main: {
			pubkeys: i,
...
function kn(e) {
	let t = Kt(e) === "P2PK" ? Jt(e) : "", n = Zt(e, "pubkeys") ?? [], r = (t ? [t, ...n] : n).map((e) => un(e));
	if (B(r).length !== r.length) throw new v("Duplicate main pubkeys are not allowed");
	return r;
}
function An(e) {
	let t = (Zt(e, "refund") ?? []).map((e) => un(e));
...
function Nn(e, t, n) {
	return !n.length && t === "EXPIRED" ? 0 : Math.max($t(e, "n_sigs") ?? 1, 1);
}
function Pn(e, t, n) {
	return n.length && t === "EXPIRED" ? Math.max($t(e, "n_sigs_refund") ?? 1, 1) : 0;
}
function Fn(e, t, n) {
	let r = [];
...
var zn = (e, t, n, r) => {
	...
	let i = I(e), a = n.add(r.multiply(t.r)), o = l.Point.BASE.multiply(t.r);
	return zn(t, i.add(o), a, r);
}, Vn = (e, t) => {
	let n = l.Point.Fn.fromBytes(t), i = l.Point.BASE.multiply(n), a = e.multiply(n), o = Rn(t, i, e, a), s = wt([
...
}, Hn = "m/129372'/0'", Un = BigInt("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141"), Wn = /* @__PURE__ */ function(e) {
	return e[e.DEPRECATED_BIP32 = 0] = "DEPRECATED_BIP32", e[e.HMAC_SHA256 = 1] = "HMAC_SHA256", e;
}(Wn || {}), Gn = (e, t, n) => qn(e, t, n).secret, Kn = (e, t, n) => qn(e, t, n).blindingFactor;
function qn(e, t, n) {
	return Jn(e, t)(n);
}
function Jn(e, t) {
	switch (Yn(t)) {
		case Wn.DEPRECATED_BIP32: {
			let n = g.fromMasterSeed(e);
			return (e) => Xn(n, t, e);
		}
		case Wn.HMAC_SHA256: return (n) => Zn(e, t, n);
	}
}
function Yn(e) {
	let t = /^[a-fA-F0-9]+$/.test(e);
	if (!t && Se(e) || t && e.startsWith("00")) return Wn.DEPRECATED_BIP32;
	if (t && (e.startsWith("01") || e.startsWith("02"))) return Wn.HMAC_SHA256;
	throw new v(`Unrecognized keyset ID version ${e.slice(0, 2)}`);
}
function Xn(e, t, n) {
	let r = `${Hn}/${Lt(t)}'/${n}'`, i = e.derive(r), a = i.deriveChild(0).privateKey, o = i.deriveChild(1).privateKey;
	/* c8 ignore next */
...
function rr(e, t = C, n) {
	let r;
	n = n ?? e.secret;
	let i = Wt(e.secret), a = yn(e, t, n);
	if (a.path != "MAIN" || Kt(i) !== "HTLC") return a;
	let o = ar(e.witness);
	return o ? nr(o, Jt(i)) ? (r = a, t.debug("Spending condition satisfied via hashlock (receiver) pathway", { result: r }), r) : (r = {
		...a,
		success: !1,
		path: "FAILED"
...
function Rr(e) {
	let t = [];
	if (e.id && t.push(H(ur, zr(e.id))), e.amount !== void 0 && t.push(H(dr, Br(e.amount))), e.unit && (e.unit === "sat" ? t.push(H(fr, new Uint8Array([0]))) : t.push(H(fr, zr(e.unit)))), e.singleUse !== void 0 && t.push(H(pr, Vr(+!!e.singleUse))), e.mints && e.mints.length > 0) for (let n of e.mints) t.push(H(mr, zr(n)));
	if (e.description && t.push(H(hr, zr(e.description))), e.transports && e.transports.length > 0) for (let n of e.transports) t.push(H(gr, Wr(n)));
	if (e.nut10 && e.nut10.length > 0) for (let n of e.nut10) t.push(H(_r, Gr(n)));
...
function Wr(e) {
	...
	t.push(H(yr, r));
	let a = [...i, ...e.tags || []];
	if (a.length > 0) for (let e of a) t.push(H(br, Kr(e)));
...
function Gr(e) {
	let t = [], n = Ur(e.kind);
	if (t.push(H(Cr, Vr(n))), t.push(H(wr, zr(e.data))), e.tags && e.tags.length > 0) for (let n of e.tags) t.push(H(Tr, Kr(n)));
...
function Ci(e, t, r) {
	...
	try {
		...
		return Bn(new TextEncoder().encode(e.secret), t, L(e.C), L(a));
	} catch {
		return !1;
	}
}
function wi(e, t, n) {
	...
	for (let e of r) (R(e.id) ? o : s).push(e);
...
function Ti(e) {
	let t = new TextEncoder(), n = J(e.proofs), r = ke(ci({
		...e,
		proofs: n
	}));
...
var ia = class {
	...
	async registerPartition(e, t, n) {
		if (!/^[0-9a-fA-F]{64}$/.test(e)) throw new v("conditionId must be a 64-character hex string for CTF partition registration");
		let r = await this.requestWithAuth("POST", `/v1/conditions/${e.toLowerCase()}/partitions`, { requestBody: t }, n);
		if (!G(r) || !G(r.keysets)) throw this._logger.error("Invalid response from mint...", {
			data: r,
			op: "registerPartition"
		}), new v("Invalid response from mint");
		return r;
	}
	...
	async ctfMerge(e, t) {
		...
		}, r = await this.requestWithAuth("POST", "/v1/ctf/merge", { requestBody: n }, t);
		if (!G(r) || !Array.isArray(r.signatures)) throw this._logger.error("Invalid response from mint...", {
			data: r,
			op: "ctfMerge"
		}), new v("Invalid response from mint");
	...
	async connectWebSocket() {
		try {
			...
			let n = e.toString();
			this.ws || (this.ws = new oa(n, this._logger)), await this.ws.ensureConnection();
		} catch (e) {
	...
	normalizeMintQuoteBolt12Fields(e) {
		gi(e, "amount"), e.amount = e.amount === null ? null : A.from(e.amount), e.expiry = Y(e.expiry, "mintQuoteBolt12.expiry", null), e.amount_paid = A.from(e.amount_paid), e.amount_issued = A.from(e.amount_issued);
	}
	...
	static verifyConditionalKeysetId(e, t) {
		try {
			return !e.keys || Object.keys(e.keys).length === 0 ? !1 : rt({
				keys: e.keys,
				input_fee_ppk: e.input_fee_ppk,
	...
	buildKeychain(e, t) {
		...
		for (let t of e) {
			let e = n.get(t.id), r = e ? ca.fromMintApi(t, e) : ca.fromMintApi(t);
	...
	async ensureKeysetKeys(e) {
		...
		let r = (async () => {
			...
			let r = t.toMintKeyset(), i = ca.fromMintApi(r, n);
	...
	registerConditionalKeyset(e, t) {
		let n = t ? ca.fromMintApi(e, t) : ca.fromMintApi(e);
...
}, da = 1024, fa = "Inputs may already be spent; if the wallet is seeded, try restoring (NUT-09) to recover.", pa = new Set([
	"locktime",
	"pubkeys",
	"n_sigs",
	"refund",
...
function ma(e) {
	...
	if (pa.has(e)) throw new v(`additionalTags must not use reserved key "${e}"`);
}
var Q = class e {
	constructor(e, t, n, r) {
	...
	toProof(e, t) {
		if (e == null) throw new v(`Mint response is missing a signature for one of the outputs. ${fa}`);
		...
		if (!n.isZero() && !e.amount.equals(n)) throw new v(`Mint signature amount ${e.amount.toString()} does not match requested amount ${n.toString()}. ${fa}`);
		if (R(e.id)) {
			let n, r;
			try {
				...
				throw new v(`Mint returned invalid signature or amount. ${fa}`, { cause: e });
			}
			let i = vt({
				id: e.id,
				C_: n
	...
	static createSingleP2PKData(t, n, r) {
		...
		if (C > 1024) throw new v(`Secret too long (${C} characters), maximum is ${da}`);
		let w = new TextEncoder().encode(S), { r: T, B_: ee } = ga(w, r);
		return new e(new ua(i, ee, r).getSerializedBlindedMessage(), T, w, _);
	}
	...
	static createSingleRandomData(t, n) {
		let r = A.from(t), i = d(m(32)), a = new TextEncoder().encode(i), { r: o, B_: s } = ga(a, n);
		return new e(new ua(r, s, n).getSerializedBlindedMessage(), o, a);
	}
	static createDeterministicData(e, t, n, r, i) {
		let a = U(e, r.keys, i), o = Jn(t, r.id);
		return a.map((e, t) => ha(e, r.id, o(n + t)));
	}
	static createSingleDeterministicData(e, t, n, r) {
		return ha(e, r, qn(t, r, n));
	}
...
function ha(e, t, n) {
	let r = A.from(e), i = d(n.secret), a = new TextEncoder().encode(i), { r: o, B_: s } = ga(a, t, O.toBigInt(n.blindingFactor));
	return new Q(new ua(r, s, t).getSerializedBlindedMessage(), o, a);
}
function ga(e, t, n) {
	if (R(t)) {
		let t = gt(e, n);
...
var va = class e {
	...
	lockUntil(e) {
		return this.locktime = _a(e), this;
	}
...
function Oa(e) {
	return e instanceof Error ? e : new v(typeof e == "string" ? e : Da(e), { cause: e });
}
function ka() {
...
var Aa = class {
	...
	waitUntilPaid(e, t, n, r = "Timeout waiting for paid") {
		return new Promise((i, a) => {
			let o = null, s = null, c = !1, l = (e) => {
				c || (c = !0, $(o), s && (clearTimeout(s), s = null), n?.signal && n.signal.removeEventListener("abort", u), e && a(Oa(e)));
			}, u = () => l(ka());
			if (n?.signal) {
	...
	async proofStateUpdates(e, t, n, r) {
		...
		for (let t of e) {
			let e = R(t.id) ? F(a.encode(t.secret)).toHex(!0) : I(a.encode(t.secret)).toHex(!0);
		...
		return new Promise((n, r) => {
			let i = Array.from(new Set(e)), a = /* @__PURE__ */ new Map(), o = null, s = null, c = !1, l = !1, u = (e) => {
				if (!l) {
					...
					a.clear(), o && (clearTimeout(o), o = null), t?.signal && t.signal.removeEventListener("abort", d), e && r(Oa(e));
				}
			}, d = () => u(ka());
			if (t?.signal) {
	...
	send(e, t) {
		return new Ma(this.wallet, e, t);
	}
	receive(e) {
		return new Na(this.wallet, e);
	}
	mintBolt11(e, t) {
	...
	mintOnchain(e, t) {
		return new Pa(this.wallet, "onchain", e, t);
	}
	meltBolt11(e, t) {
		return new Fa(this.wallet, "bolt11", e, t);
	}
	meltBolt12(e, t) {
		return new Fa(this.wallet, "bolt12", e, t);
	}
	meltOnchain(e, t) {
		return new Ia(this.wallet, e, t);
	}
}, Ma = class {
	constructor(e, t, n) {
...
}, La = "__PENDING__", Ra = class e {
	constructor(e, t) {
		this._seed = void 0, this._unit = "sat", this._mintInfo = void 0, this._denominationTarget = 3, this._secretsPolicy = "auto", this._boundKeysetId = La, this._requireSigDleq = !1, this.ops = new ja(this), this.on = new Aa(this), this._logger = t?.logger ?? C, this._selectProofs = t?.selectProofs ?? ya, this._outputDataCreator = t?.outputDataCreator ?? new ba(), this.mint = typeof e == "string" ? new sa(e, {
			authProvider: t?.authProvider,
			logger: this._logger
		}) : e, this._unit = t?.unit ?? this._unit, this._boundKeysetId = t?.keysetId ?? this._boundKeysetId, t?.bip39seed && (this.failIf(!(t.bip39seed instanceof Uint8Array), "bip39seed must be a valid Uint8Array", { bip39seed: t.bip39seed }), this._seed = t.bip39seed), this._secretsPolicy = t?.secretsPolicy ?? this._secretsPolicy, t?.counterSource ? this._counterSource = t.counterSource : this._counterSource = new wa(t?.counterInit), this.counters = new Ea(this._counterSource), this._keyChain = new la(this.mint, this._unit), this._denominationTarget = t?.denominationTarget ?? this._denominationTarget, this._requireSigDleq = t?.requireSigDleq ?? this._requireSigDleq, this.ctf = t?.enableCtf ? this.createCtfFacade() : void 0;
	}
	createCtfFacade() {
		return {
	...
	configureOutputs(e, t, n, r = !1, i = []) {
		...
		if (s.length === 0 && o.length > 0 && (s = Sa(o, a, t.keys, this._denominationTarget)), s = U(a, t.keys, s), r) {
	...
	sendOffline(e, t, n) {
		...
		a && (i = i.filter((e) => R(e.id) || e.dleq != null)), this.failIf(q(i).lessThan(r), "Not enough funds available to send");
	...
	async prepareMint(e, t, n, r, i) {
		...
		if ("pubkey" in n && n.pubkey && this.failIf(!o, "Can not sign locked quote without private key"), o) {
			...
			let t = e ? et(e, o) : Array.isArray(o) ? o[0] : o;
	...
	async checkProofsStates(e) {
		let t = new TextEncoder(), n = e.map((e) => R(e.id) ? F(t.encode(e.secret)).toHex(!0) : I(t.encode(e.secret)).toHex(!0)), r = [];
	...
	async init() {
		...
		if (!this.keychain) {
			let [e, t] = await Promise.all([this.req({
				...
				method: "GET"
			})]), n = e.keysets.map((e) => ki(e)), r = t.keysets.map((e) => Ai(e)), i = la.mintToCacheDTO(this.mintUrl, n, r);
			this.keychain = la.fromCache(this.mintUrl, "auth", i), this.keychain.getCheapestKeyset();
		}
	}
	getBatMaxMint() {
...
function Ga(e) {
	...
	let n = j.stringify(t) ?? "{}";
	return `${Ua}${_e(O.fromString(n))}`;
}
function Ka(e, t) {
	if (!e.startsWith(Ua)) throw new v(`Invalid signing package: must start with "${Ua}"`);
	let n = e.slice(7), r;
	try {
	...
	let a = i, o = a.version;
	if (o !== Ua) throw new v(`Invalid signing package version: ${o}`);
	let s = a.type;
	...
	if (t?.validateDigest) {
		let e = Wa(a.inputs, a.outputs, a.quote);
...
function qa(e, t) {
	...
	if (n.push(Ze(e.digests.current, t)), e.digests.legacy && n.push(Ze(e.digests.legacy, t)), n.length === 0) throw new v("No signatures produced during signing");
	return {
		...e,
...
function Ja(e) {
	...
	return Xa("swap", e.inputs, t.map((e) => e.blindedMessage));
}
function Ya(e) {
	return Xa("melt", e.inputs, e.outputData.map((e) => e.blindedMessage), e.quote.quote);
}
function Xa(e, t, n, r) {
	let i = Wa(t, n, r), a = P(Cn(t, n.map((e) => ({ blindedMessage: e })), r), !0);
...
var eo = {
	computeDigests: Wa,
	extractSwapPackage: Ja,
	extractMeltPackage: Ya,
	serializePackage: Ga,
	deserializePackage: Ka,
	signPackage: qa,
	signDigest: Ze,
	mergeSwapPackage: Za,
	mergeMeltPackage: Qa
...
//#endregion
export { A as Amount, k as AmountError, ae as AmountWithUnit, ie as AmountWithUnitError, Ba as AuthManager, ot as BLS_FR_ORDER, st as BLS_G2_GENERATOR, at as BLS_HASH_TO_CURVE_DST, v as CTSError, sa as CashuMint, sa as Mint, Ra as CashuWallet, Ra as Wallet, Pi as CheckStateEnum, te as ConsoleLogger, y as HttpResponseError, j as JSONInt, la as KeyChain, ca as Keyset, Fa as MeltBuilder, Ia as MeltOnchainBuilder, Ni as MeltQuoteState, Pa as MintBuilder, X as MintInfo, S as MintOperationError, Mi as MintQuoteState, b as NetworkError, ji as OIDCAuth, Q as OutputData, en as P2BK_DST, va as P2PKBuilder, Xr as PaymentRequest, lr as PaymentRequestTransportType, x as RateLimitError, Na as ReceiveBuilder, Ma as SendBuilder, eo as SigAll, on as SigFlags, oa as WSConnection, Ea as WalletCounters, Aa as WalletEvents, ja as WalletOps, Pt as asBlsG1Point, Nt as asSecpPoint, Gt as assertSecretKind, Sn as assertSigAllInputs, St as batchVerifyUnblindedSignatureBls, ii as bigIntStringify, At as blindMessage, gt as blindMessageBls, Fn as buildLegacyP2PKSigAllMessage, Cn as buildP2PKSigAllMessage, P as computeMessageDigest, Mt as constructUnblindedSignature, vt as constructUnblindedSignatureBls, Ha as createAuthWallet, Ot as createBlindSignature, yt as createBlindSignatureBls, Vn as createDLEQProof, Ta as createEphemeralCounterSource, tr as createHTLCHash, $n as createHTLCsecret, Vt as createNewMintKeys, ln as createP2PKsecret, kt as createRandomRawBlindedMessage, Dt as createRandomSecretKey, Ut as createSecret, Jn as createSecretAndBlindingFactorDeriver, bi as decodePaymentRequest, B as dedupeP2PKPubkeys, xt as deriveBatchWeights, Kn as deriveBlindingFactor, rt as deriveConditionalKeysetId, pi as deriveKeysetId, tn as deriveP2BKBlindedPubkeys, rn as deriveP2BKSecretKey, nn as deriveP2BKSecretKeys, Gn as deriveSecret, qn as deriveSecretAndBlindingFactor, Bt as deserializeMintKeys, yi as deserializeProofs, et as findSigningKey, Jt as getDataField, ui as getDecodedToken, Ei as getDecodedTokenBinary, oi as getEncodedToken, oi as getEncodedTokenV4, Ti as getEncodedTokenBinary, mt as getG2PubKeyFromPrivKey, ar as getHTLCWitnessPreimage, Zr as getKeysetAmounts, Lt as getKeysetIdInt, fn as getP2PKExpectedWitnessPubkeys, pn as getP2PKSigFlag, mn as getP2PKWitnessSignatures, Et as getPubKeyFromPrivKey, qt as getSecretData, Kt as getSecretKind, Zt as getTag, $t as getTagInt, Qt as getTagScalar, Yt as getTags, di as getTokenMetadata, tt as getValidSigners, $r as hasCorrespondingKey, vn as hasP2PKSignedProof, Xt as hasTag, Ci as hasValidDleq, I as hashToCurve, F as hashToCurveBls, wt as hash_e, ti as hexToNumber, na as injectWebSocketImpl, Oi as invoiceHasAmountInHRP, R as isBlsKeyset, ir as isHTLCSpendAuthorised, G as isObj, wn as isP2PKSigAll, bn as isP2PKSpendAuthorised, W as isValidHex, K as joinUrls, xn as maybeDeriveP2BKPrivateKeys, nt as meetsSignerThreshold, dn as normalizeP2PKOptions, J as normalizeProofAmounts, _i as normalizeUrl, gi as nullIfUndefined, ni as numberToHexPadded64, er as parseHTLCSecret, z as parseP2PKSecret, Wt as parseSecret, hn as parseWitnessData, Tt as pointFromBytes, L as pointFromHex, Ft as pointFromHexAuto, ft as pointFromHexG1, pt as pointFromHexG2, It as pointToHex, Ze as schnorrSignDigest, Qe as schnorrSignMessage, $e as schnorrVerifyMessage, ya as selectProofsRGLI, zt as serializeMintKeys, vi as serializeProofs, Vi as setGlobalRequestOptions, sr as signMintQuote, _n as signP2PKProof, gn as signP2PKProofs, hi as sortProofsById, U as splitAmount, xi as stripDleq, q as sumProofs, jt as unblindSignature, _t as unblindSignatureBls, zn as verifyDLEQProof, Bn as verifyDLEQProof_reblind, nr as verifyHTLCHash, rr as verifyHTLCSpendingConditions, cr as verifyMintQuoteSignature, yn as verifyP2PKSpendingConditions, wi as verifyProofsForReceive, Ht as verifyUnblindedSignature, bt as verifyUnblindedSignatureBls };
