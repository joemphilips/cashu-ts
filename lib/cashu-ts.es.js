...
function N(t) {
	...
	for (let t = 0; t < i; t++) {
		...
		try {
			return P(e(D.concat(new Uint8Array([2]), i)));
		} catch {
			r[0]++;
		}
	}
...
function Mt() {
	let t = e(i(32));
	return Nt(new TextEncoder().encode(t));
}
function Nt(e, t) {
	let n = N(e);
	if (t === void 0) t = l.Point.Fn.fromBytes(At());
	else if (t === 0n) throw new v("Blinding factor r must be non-zero");
...
function Bt(e) {
	if (/^[A-Za-z0-9+/]{12}$/.test(e)) return "secp256k1";
	if (!V(e)) throw new v("Malformed Cashu keyset ID");
	let t = e.slice(0, 2).toLowerCase();
	if (t === "00" && e.length === 16) return "secp256k1";
	if ((t === "01" || t === "02") && (e.length === 16 || e.length === 66)) return t === "02" ? "bls12-381" : "secp256k1";
	throw t === "00" || t === "01" || t === "02" ? new v("Malformed Cashu keyset ID") : new v(`Unrecognized Cashu keyset ID version: ${t}`);
}
function F(e) {
	try {
		return Bt(e) === "bls12-381";
	} catch {
		return !1;
	}
}
...
function Kt(e, t) {
	...
	let n = N(e.secret), r = l.Point.Fn.fromBytes(t);
...
function on(e, t) {
	...
	return {
		blinded: e.map((e, t) => {
			let r = P(e), i = ln(r, n, t), a = r.add(l.Point.BASE.multiply(i));
...
function Cn(e, t = C, n) {
	...
	n = n ?? e.secret;
	let r = I(e.secret), i = Nn(r), a = Pn(r);
	Mn({
...
function Nn(e) {
	...
	if (L(r).length !== r.length) throw new v("Duplicate main pubkeys are not allowed");
	return r;
}
function Pn(e) {
	let t = (tn(e, "refund") ?? []).map((e) => mn(e));
	if (L(t).length !== t.length) throw new v("Duplicate refund pubkeys are not allowed");
	return t;
}
function Fn(e) {
	let t = rn(e, "locktime");
...
var Un = (e, t, n, r) => {
	let i = l.Point.Fn.fromBytes(e.s), a = l.Point.Fn.fromBytes(e.e), o = l.Point.BASE.multiply(i), s = r.multiply(a), c = t.multiply(i), u = n.multiply(a), d = Dt([
		o.subtract(s),
		c.subtract(u),
		r,
		n
	...
	let i = N(e), a = n.add(r.multiply(t.r)), o = l.Point.BASE.multiply(t.r);
	return Un(t, i.add(o), a, r);
}, Gn = (e, t) => {
	let n = l.Point.Fn.fromBytes(t), i = l.Point.BASE.multiply(n), a = e.multiply(n), o = Hn(t, i, e, a), s = Dt([
...
function jr(e) {
	...
	for (let e of t) switch (e.tag) {
		...
		case mr:
			...
			break;
		case hr:
			e.value.length === 1 && e.value[0] === 0 ? n.unit = "sat" : n.unit = R(e.value);
			break;
		case gr:
			n.singleUse = Fr(e.value) === 1;
			break;
		case _r:
			n.mints || (n.mints = []), n.mints.push(R(e.value));
			break;
		case vr:
			n.description = R(e.value);
			break;
		case yr:
...
function Vr(e) {
	let t = [];
	if (e.id && t.push(z(pr, Hr(e.id))), e.amount !== void 0 && t.push(z(mr, Ur(e.amount))), e.unit && (e.unit === "sat" ? t.push(z(hr, new Uint8Array([0]))) : t.push(z(hr, Hr(e.unit)))), e.singleUse !== void 0 && t.push(z(gr, Wr(+!!e.singleUse))), e.mints && e.mints.length > 0) for (let n of e.mints) t.push(z(_r, Hr(n)));
	if (e.description && t.push(z(vr, Hr(e.description))), e.transports && e.transports.length > 0) for (let n of e.transports) t.push(z(yr, qr(n)));
	if (e.nut10 && e.nut10.length > 0) for (let n of e.nut10) t.push(z(br, Jr(n)));
...
function qr(e) {
	...
	t.push(z(Sr, r));
	let a = [...i, ...e.tags || []];
	if (a.length > 0) for (let e of a) t.push(z(Cr, Yr(e)));
...
function Jr(e) {
	let t = [], n = Kr(e.kind);
	if (t.push(z(Er, Wr(n))), t.push(z(Dr, Hr(e.data))), e.tags && e.tags.length > 0) for (let n of e.tags) t.push(z(Or, Yr(n)));
...
function oi(e) {
	return Array.isArray(e) ? e.some((e) => !V(e.id)) : !V(e.id);
}
function si(e, t) {
...
function Si(e) {
	...
	return G(e.map((e) => typeof e == "string" ? A.parse(e) : e));
}
function Ci(e) {
...
function Ei(e, t, r) {
	...
	try {
		...
		return Wn(new TextEncoder().encode(e.secret), t, P(e.C), P(a));
	} catch {
		return !1;
	}
}
function Di(e, t, n) {
	let r = G(e), i = n?.requireDleq ?? !1, a = i ? "Token contains proofs with invalid or missing DLEQ" : "Token contains a proof with an invalid DLEQ", o = [], s = [];
	for (let e of r) (F(e.id) ? o : s).push(e);
...
function Oi(e) {
	let t = new TextEncoder(), n = G(e.proofs), r = Ae(di({
		...e,
		proofs: n
	}));
...
function Mi(e) {
	return {
		...e,
		input_fee_ppk: K(e.input_fee_ppk, "keyset.input_fee_ppk", void 0),
		final_expiry: K(e.final_expiry, "keyset.final_expiry", void 0)
	};
}
function Ni(e) {
	return {
		...e,
		input_fee_ppk: K(e.input_fee_ppk, "keys.input_fee_ppk", void 0),
		final_expiry: K(e.final_expiry, "keys.final_expiry", void 0)
	};
}
//#endregion
...
var Pi = class e {
	...
	static normalizeNut22(e, t) {
		...
		let n = 100;
		try {
			n = K(e.bat_max_mint, "nuts.22.bat_max_mint", 100);
		} catch {
	...
	static normalizeNut29(e, t) {
		...
		let n = 100;
		try {
			n = K(e.max_batch_size, "nuts.29.max_batch_size", 100);
		} catch {
	...
	checkNut19() {
		...
		if (e && (e?.cached_endpoints?.length || 0) > 0) {
			let t = K(e.ttl, "nuts.19.ttl", null);
			return {
				supported: !0,
				params: {
		...
		try {
			...
			if (Zi(n)) {
				...
				if (u < Wi && (!t || r < t)) {
					...
					if (r + a > t) throw X.error(`Network Error: request abandoned after ${u} retries`, {
						e: n,
						retries: u
					}), n;
					return u++, X.info(`Network Error: attempting retry ${u} in ${a}ms`, {
						e: n,
						retries: u,
						delay: a
...
async function ia(e, t) {
	...
	try {
		...
		throw X.error("Failed to parse HTTP response", { err: i }), new y("bad response", e.status, { cause: i });
	}
...
function la(e, t) {
	try {
		...
		throw X.error("Failed to parse HTTP response", { err: t }), new y("bad response", e.status, { cause: t });
	}
}
function ua(e) {
	return e instanceof Z ? e : new Z("Failed to read response body", 0, "read-failed", { cause: e });
}
async function da(e, t) {
	if (t !== void 0 && (!Number.isSafeInteger(t) || t < 1)) throw new Z("Response body byte limit is invalid", 0, "read-failed");
	let n = e.headers.get("Content-Length");
	if (t !== void 0 && n !== null && /^\d+$/.test(n) && Number(n) > t) throw e.body?.cancel().catch(() => void 0), new Z("Response body exceeds configured byte limit", 0, "limit-exceeded");
	if (!e.body) {
		let n;
		try {
			n = await e.text();
		} catch (e) {
			throw new Z("Failed to read response body", 0, "read-failed", { cause: e });
		}
		let r = new TextEncoder().encode(n).byteLength;
		if (t !== void 0 && r > t) throw new Z("Response body exceeds configured byte limit", r, "limit-exceeded");
		return {
			text: n,
			decodedBodyBytes: r
		};
...
async function fa(e, t) {
	...
	try {
		for (;;) {
			...
			if (e) break;
			if (a += o.byteLength, t !== void 0 && a > t) throw n.cancel().catch(() => void 0), new Z("Response body exceeds configured byte limit", a, "limit-exceeded");
		...
		throw e instanceof Z ? e : new Z("Failed to read response body", a, "read-failed", { cause: e });
	} finally {
		n.releaseLock();
	}
}
...
async function ma(e) {
	let t = e.onResponseMeta, n = Y.onResponseMeta, r = e.onResponseBody, i = Y.onResponseBody, a = {
		...e,
		...Y
	};
	return a.requestTimeout = va(e.requestTimeout, Y.requestTimeout), a.responseBodyBytesLimit = ya(e.responseBodyBytesLimit, Y.responseBodyBytesLimit), a.signal = e.signal ?? Y.signal, t && (a.onResponseMeta = t), t && n && t !== n && (a.onResponseMeta = (r) => {
		T(t, r, X, {
			op: "request.onResponseMeta",
			scope: "per-request",
			endpoint: e.endpoint
...
var Ca = class {
	...
	async getInfo(e) {
		let t = await (e ?? this._request)({
			endpoint: U(this._mintUrl, "/v1/info"),
	...
	async swap(e, t) {
		...
		if (!H(n) || !Array.isArray(n?.signatures)) throw this._logger.error("Invalid response from mint...", {
			data: n,
			op: "swap"
	...
	async mint(e, t, n) {
		...
		if (!H(r) || !Array.isArray(r?.signatures)) throw this._logger.error("Invalid response from mint...", {
			data: r,
			op: `mint.${e}`
		}), new v("Invalid response from mint");
	...
	async mintBatch(e, t, n) {
		...
		if (!H(i) || !Array.isArray(i?.signatures)) throw this._logger.error("Invalid response from mint...", {
			data: i,
			op: `mintBatch.${e}`
		}), new v("Invalid response from mint");
	...
	async check(e, t) {
		...
		if (!H(n) || !Array.isArray(n?.states)) throw this._logger.error("Invalid response from mint...", {
			op: "check",
	...
	async getKeys(e, t, n) {
		...
		let i = await (n ?? this._request)({
			endpoint: e ? U(r, "/v1/keys", e) : U(r, "/v1/keys"),
			onResponseMeta: this._captureResponseMetadata
		});
		if (!H(i) || !Array.isArray(i.keysets)) throw this._logger.error("Invalid response from mint...", {
			op: "getKeys",
	...
	async getKeySets(e) {
		let t = await (e ?? this._request)({
			endpoint: U(this._mintUrl, "/v1/keysets"),
			onResponseMeta: this._captureResponseMetadata
		});
		if (!H(t) || !Array.isArray(t.keysets)) throw this._logger.error("Invalid response from mint...", {
			op: "getKeySets",
			reason: "response must contain a keysets array"
		}), new v("Invalid response from mint");
		return {
	...
	async restore(e, t) {
		let n = await (t ?? this._request)({
			endpoint: U(this._mintUrl, "/v1/restore"),
			method: "POST",
			requestBody: e,
			onResponseMeta: this._captureResponseMetadata
		});
		if (!H(n) || !Array.isArray(n?.outputs) || !Array.isArray(n?.signatures)) throw this._logger.error("Invalid response from mint...", {
			op: "restore",
	...
	async getConditionalKeysets(e = {}, t) {
		...
		let r = n.toString(), i = r ? `/v1/conditional_keysets?${r}` : "/v1/conditional_keysets", a = await this.requestWithAuth("GET", i, { responseBodyBytesLimit: 16 * 1024 * 1024 }, t), o = (e) => {
			...
			if (e != null) {
				...
				try {
					return K(e, `conditional_keyset.${t}`, void 0);
				} catch {
					return o(`${t} must be a safe non-negative integer when present`);
				}
			}
		};
		if (!H(a)) return o("response must be an object");
		let l = a;
		...
		let u = {
			keysets: l.keysets.map((e) => {
				if (!H(e)) return o("keyset entries must be objects");
				let t = e;
	...
	async getConditions(e = {}, t) {
		...
		if (!H(a) || !Array.isArray(a.conditions)) throw this._logger.error("Invalid response from mint...", {
			data: a,
			op: "getConditions"
		}), new v("Invalid response from mint");
		return a;
	...
	async registerCondition(e, t) {
		...
		if (!H(n) || typeof n.condition_id != "string") throw this._logger.error("Invalid response from mint...", {
			data: n,
	...
	async getCtfCondition(e, t) {
		...
		let n = e.toLowerCase(), r = await this.getCtfConditionResponse(n, t), i = r, a = this.normalizeCtfCondition(H(i.condition) ? i.condition : r);
		if (!H(a) || a.condition_id?.toLowerCase() !== n || !H(a.keysets)) throw this._logger.error("Invalid response from mint...", {
			data: r,
			op: "getCtfCondition"
	...
	normalizeCtfCondition(e) {
		if (H(e.keysets) || !Array.isArray(e.partitions)) return e;
		let t = {};
		for (let n of e.partitions) if (!(!H(n) || !H(n.keysets))) for (let [e, r] of Object.entries(n.keysets)) typeof r == "string" && (t[e] = r);
		return {
			...e,
			keysets: t
		};
	...
	async getCtfConditionResponse(e, t) {
		try {
			...
			let r = await this.requestWithAuth("GET", "/v1/conditions", {}, t), i = (Array.isArray(r) ? r : H(r) && Array.isArray(r.conditions) ? r.conditions : []).find((t) => t.condition_id?.toLowerCase() === e);
			if (!i) throw n;
			return i;
		}
	}
	...
	async ctfConvert(e, t) {
		...
		if (!H(r) || !H(r.signatures)) throw this._logger.error("Invalid response from mint...", {
			data: r,
			op: "ctfConvert"
		}), new v("Invalid response from mint");
	...
	normalizeMintQuoteBolt11Fields(e) {
		e.amount = k.from(e.amount), e.expiry = K(e.expiry, "mintQuoteBolt11.expiry", null);
	}
	normalizeMintQuoteBolt12Fields(e) {
		yi(e, "amount"), e.amount = e.amount === null ? null : k.from(e.amount), e.expiry = K(e.expiry, "mintQuoteBolt12.expiry", null), e.amount_paid = k.from(e.amount_paid), e.amount_issued = k.from(e.amount_issued);
	}
	normalizeMintQuoteOnchainFields(e) {
		e.expiry = K(e.expiry, "mintQuoteOnchain.expiry", null), e.amount_paid = k.from(e.amount_paid), e.amount_issued = k.from(e.amount_issued);
	}
	...
	normalizeMeltBaseFields(e, t) {
		if (e.amount = k.from(e.amount), e.expiry = K(e.expiry, "meltQuote.expiry", void 0), e.change && (e.change = this.normalizeSignatureAmounts(e.change)), !H(e) || typeof e.quote != "string" || !(e.amount instanceof k) || typeof e.unit != "string" || typeof e.state != "string" || typeof e.expiry != "number" || !Object.values(Ii).includes(e.state)) throw this._logger.error("Invalid response from mint...", {
			data: e,
			op: t
		}), new v("Invalid response from mint");
	}
	...
	static verifyKeysetId(e) {
		try {
			...
			let t = Ce(e.id) && !V(e.id), r = V(e.id) ? n(e.id)[0] : 0;
			return gi(e.keys, {
	...
	buildKeychain(e, t) {
		...
		for (let t of e) {
			let e = n.get(t.id), r = e ? Da.fromMintApi(t, e) : Da.fromMintApi(t);
	...
	async ensureKeysetKeys(e) {
		...
		let r = (async () => {
			...
			let r = t.toMintKeyset(), i = Da.fromMintApi(r, n);
	...
	registerConditionalKeyset(e, t) {
		let n = t ? Da.fromMintApi(e, t) : Da.fromMintApi(e);
...
}, Aa = 1024, ja = "Inputs may already be spent; if the wallet is seeded, try restoring (NUT-09) to recover.", Ma = new Set([
	"locktime",
	"pubkeys",
	"n_sigs",
	"refund",
...
function Na(e) {
	...
	if (Ma.has(e)) throw new v(`additionalTags must not use reserved key "${e}"`);
}
var Q = class e {
	constructor(e, t, n, r) {
	...
	toProof(e, t) {
		if (e == null) throw new v(`Mint response is missing a signature for one of the outputs. ${ja}`);
		...
		if (!n.isZero() && !e.amount.equals(n)) throw new v(`Mint signature amount ${e.amount.toString()} does not match requested amount ${n.toString()}. ${ja}`);
		if (F(e.id)) {
			let n, r;
			try {
				...
				throw new v(`Mint returned invalid signature or amount. ${ja}`, { cause: e });
			}
			let i = xt({
				id: e.id,
				C_: n
		...
		if (e.dleq && (a = {
			...
			let e = Rt(this.blindedMessage.B_);
	...
	static createP2PKData(e, t, n, r) {
		return B(t, n.keys, r).map((t) => this.createSingleP2PKData(e, t, n.id));
	}
	static createSingleP2PKData(t, n, r) {
		...
		if (Number.isSafeInteger(b) && b >= 0 && y.push(["locktime", String(b)]), h.length > 0 && (y.push(["pubkeys", ...h]), c > 1 && y.push(["n_sigs", String(c)])), g.length > 0 && (y.push(["refund", ...g]), l > 1 && y.push(["n_sigs_refund", String(l)])), a.sigFlag == "SIG_ALL" && y.push(["sigflag", "SIG_ALL"]), a.additionalTags?.length) {
			let e = a.additionalTags.map(([e, ...t]) => (Na(e), [e, ...t.map(String)]));
			y.push(...e);
		}
		let x = [f ? "HTLC" : "P2PK", {
			nonce: d(m(32)),
		...
		if (C > 1024) throw new v(`Secret too long (${C} characters), maximum is ${Aa}`);
		let ee = new TextEncoder().encode(S), { r: w, B_: te } = La(ee, r);
		return new e(new ka(i, te, r).getSerializedBlindedMessage(), w, ee, _);
	}
	static createRandomData(e, t, n) {
		return B(e, t.keys, n).map((e) => this.createSingleRandomData(e, t.id));
	}
	static createSingleRandomData(t, n) {
		let r = k.from(t), i = d(m(32)), a = new TextEncoder().encode(i), { r: o, B_: s } = La(a, n);
		return new e(new ka(r, s, n).getSerializedBlindedMessage(), o, a);
	}
	static createDeterministicData(e, t, n, r, i) {
		let a = B(e, r.keys, i), o = Zn(t, r.id);
		return a.map((e, t) => Pa(e, r.id, n + t, o(n + t)));
	}
	static createSingleDeterministicData(e, t, n, r) {
		return Pa(e, r, n, Xn(t, r, n));
	}
	...
	static serialize(e) {
		return {
			...
			...e.nut13 !== void 0 && { nut13: Ia(e.nut13, e.blindedMessage.id) }
		};
	}
	static deserialize(t) {
		try {
			...
			return t.nut13 === void 0 ? n : Fa(n, t.nut13);
		} catch (e) {
...
function Pa(e, t, n, r) {
	let i = k.from(e), a = d(r.secret), o = new TextEncoder().encode(a), { r: s, B_: c } = La(o, t, D.toBigInt(r.blindingFactor));
	return Fa(new Q(new ka(i, c, t).getSerializedBlindedMessage(), s, o), {
		keysetId: t,
		counter: n
	});
}
function Fa(e, t) {
	return Object.defineProperty(e, "nut13", {
		configurable: !1,
		enumerable: !0,
		value: Ia(t, e.blindedMessage.id),
		writable: !1
	}), e;
}
function Ia(e, t) {
...
var za = class e {
	...
	addLockPubkey(e) {
		...
		return this.lockKeys = L([...this.lockKeys, ...t]), this;
	}
	addRefundPubkey(e) {
		let t = Array.isArray(e) ? e : [e];
		return this.refundKeys = L([...this.refundKeys, ...t]), this;
	}
	lockUntil(e) {
		return this.locktime = Ra(e), this;
	}
...
function Ba(e, t, n, r = !1, i = !1, a = C) {
	let o = G(e), s = k.from(t), c = s.toNumber(), l = re(), u = null, d = Infinity, f = 0, p = 0, m = (e) => {
		try {
...
var Va = class e {
	...
	createDeterministicData(t, n, r, i, a) {
		return this.createSingleDeterministicData === e.prototype.createSingleDeterministicData ? Q.createDeterministicData(t, n, r, i, a) : B(t, i.keys, a).map((e, t) => this.createSingleDeterministicData(e, n, r + t, i.id));
	}
...
function Ua(e, t, n, r) {
	...
	let c = i.subtract(o);
	if (!c.isZero()) for (let e of B(c, n)) a.push(e), o = o.add(e);
...
function Ya(e) {
	return e instanceof Error ? e : new v(typeof e == "string" ? e : Ja(e), { cause: e });
}
function Xa() {
...
var Za = class {
	...
	waitUntilPaid(e, t, n, r = "Timeout waiting for paid") {
		return new Promise((i, a) => {
			let o = null, s = null, c = !1, l = (e) => {
				c || (c = !0, $(o), s && (clearTimeout(s), s = null), n?.signal && n.signal.removeEventListener("abort", u), e && a(Ya(e)));
			}, u = () => l(Xa());
			if (n?.signal) {
	...
	async proofStateUpdates(e, t, n, r) {
		...
		for (let t of e) {
			let e = F(t.id) ? M(a.encode(t.secret)).toHex(!0) : N(a.encode(t.secret)).toHex(!0);
		...
		return new Promise((n, r) => {
			let i = Array.from(new Set(e)), a = /* @__PURE__ */ new Map(), o = null, s = null, c = !1, l = !1, u = (e) => {
				if (!l) {
					...
					a.clear(), o && (clearTimeout(o), o = null), t?.signal && t.signal.removeEventListener("abort", d), e && r(Ya(e));
				}
			}, d = () => u(Xa());
			if (t?.signal) {
	...
	send(e, t) {
		return new $a(this.wallet, e, t);
	}
	receive(e) {
		return new eo(this.wallet, e);
	}
	mintBolt11(e, t) {
	...
	mintOnchain(e, t) {
		return new to(this.wallet, "onchain", e, t);
	}
	meltBolt11(e, t) {
		return new no(this.wallet, "bolt11", e, t);
	}
	meltBolt12(e, t) {
		return new no(this.wallet, "bolt12", e, t);
	}
	meltOnchain(e, t) {
		return new ro(this.wallet, e, t);
	}
}, $a = class {
	constructor(e, t, n) {
...
var ao = "__PENDING__", oo = 300, so = 1e3, co = 1e6, lo = class e {
	constructor(e, t) {
		this._seed = void 0, this._unit = "sat", this._mintInfo = void 0, this._denominationTarget = 3, this._secretsPolicy = "auto", this._boundKeysetId = ao, this._requireSigDleq = !1, this.ops = new Qa(this), this.on = new Za(this), this._logger = t?.logger ?? C, this._selectProofs = t?.selectProofs ?? Ba, this._outputDataCreator = t?.outputDataCreator ?? new Va(), this.mint = typeof e == "string" ? new Ea(e, {
			authProvider: t?.authProvider,
			logger: this._logger
		}) : e, this._unit = t?.unit ?? this._unit, this._boundKeysetId = t?.keysetId ?? this._boundKeysetId, t?.bip39seed && (this.failIf(!(t.bip39seed instanceof Uint8Array), "bip39seed must be a valid Uint8Array", { bip39seed: t.bip39seed }), this._seed = t.bip39seed), this._secretsPolicy = t?.secretsPolicy ?? this._secretsPolicy, t?.counterSource ? this._counterSource = t.counterSource : this._counterSource = new Ga(t?.counterInit), this.counters = new qa(this._counterSource), this._keyChain = new Oa(this.mint, this._unit), this._denominationTarget = t?.denominationTarget ?? this._denominationTarget, this._requireSigDleq = t?.requireSigDleq ?? this._requireSigDleq, this.ctf = t?.enableCtf ? this.createCtfFacade() : void 0;
	}
	createCtfFacade() {
		return {
	...
	async loadMint(e, t) {
		let n = io(this.mint, t), r = [];
		(!this._mintInfo || e) && r.push(this.mint.getInfo(n).then((e) => (this._mintInfo = new q(e, this._logger), this.mint.setMintInfo(this._mintInfo), null))), r.push(this._keyChain.init(e, n)), await Promise.all(r), this.finishInit();
	}
	...
	finishInit() {
		if (this._logger.debug("KeyChain", { keychain: this._keyChain.cache }), this._boundKeysetId === ao) try {
	...
	get keysetId() {
		return this.failIf(this._boundKeysetId === ao, "Wallet has no bound keyset. The mint may have no active keysets, or wallet was not initialized via loadMint or loadMintFromCache"), this._boundKeysetId;
	}
	getKeyset(e) {
	...
	configureOutputs(e, t, n, r = !1, i = []) {
		...
		if (s.length === 0 && o.length > 0 && (s = Ua(o, a, t.keys, this._denominationTarget)), s = B(a, t.keys, s), r) {
			let e = this.getFeesForKeyset(s.length, t.id), n = B(e, t.keys);
			for (; this.getFeesForKeyset(s.length + n.length, t.id).greaterThan(e);) e = e.add(1), n = B(e, t.keys);
			a = a.add(e), s = [...s, ...n];
		}
		return {
			...n,
	...
	createOutputData(e, t, n) {
		...
		switch (n.type) {
			...
			case "p2pk":
				...
				break;
			case "factory":
				i = B(r, t.keys, n.denominations).map((e) => n.factory(e, t));
				break;
			case "custom": {
				i = n.data;
	...
	async prepareSwapToReceive(e, t, n) {
		...
		let u = this.parseAmount(W(s), "prepareSwapToReceive", !0);
	...
	sendOffline(e, t, n) {
		let r = this.parseAmount(e, "sendOffline"), i = G(t), { requireDleq: a = !1, includeFees: o = !1, exactMatch: s = !0 } = n || {};
		a && (i = i.filter((e) => F(e.id) || e.dleq != null)), this.failIf(W(i).lessThan(r), "Not enough funds available to send");
	...
	async send(e, t, n, r) {
		...
		try {
			...
			if (W(c).equals(i.add(l))) return this._logger.info("Successful exactMatch offline selection!"), {
				keep: s,
				send: c
			};
		} catch (e) {
	...
	async prepareSwapToSend(e, t, n, r) {
		let i = this.parseAmount(e, "prepareSwapToSend"), a = G(t), { keysetId: o, includeFees: s = !1, onCountersReserved: c } = n || {};
		r = r ?? {
			send: this.defaultOutputType(),
			keep: this.defaultOutputType()
		};
		...
		let m = W(p), h = this.getFeesForProofs(p), g = d.add(h);
	...
	async prepareConditionalSwap(e) {
		...
		}), c = k.from(Math.ceil(t.length * i.fee / 1e3)), l = W(t).subtract(c);
	...
	maxSpendableAfterFees(e, t = 0) {
		let n = W(e), r = this.getFeesForProofs(e).add(t);
	...
	async batchRestore(e = 300, t = 300, n = 0, r, i = {}) {
		this.failIf(!Number.isSafeInteger(e) || e < 1, "Batch restore gap limit must be a positive safe integer"), this.failIf(!Number.isSafeInteger(t) || t < 1 || t > oo, `Batch restore size must be a safe integer between 1 and ${oo}`), this.failIf(!Number.isSafeInteger(n) || n < 0, "Batch restore counter must be a non-negative safe integer");
		let a = i.maxBatches ?? so, o = i.maxCounter ?? co;
		this.failIf(!Number.isSafeInteger(a) || a < 1 || a > so, `Batch restore maximum batches must be between 1 and ${so}`), this.failIf(!Number.isSafeInteger(o) || o < 1 || o > co, `Batch restore counter horizon must be between 1 and ${co}`);
		let s = Math.ceil(e / t);
	...
	async restore(e, t, n) {
		this.failIfNullish(this._seed, "Cashu Wallet must be initialized with a seed to use restore"), this.failIf(!Number.isSafeInteger(e) || e < 0, "Restore start must be a non-negative safe integer"), this.failIf(!Number.isSafeInteger(t) || t < 1 || t > oo, `Restore count must be a safe integer between 1 and ${oo}`), this.failIf(t > 0 && e > 2 ** 53 - 1 - (t - 1), "Restore counter range exceeds the safe integer limit");
		let { keysetId: r, requestOptions: i } = n || {};
		await this._keyChain.ensureKeysetKeys(r ?? this.keysetId);
		let a = this.getKeyset(r), o = Array(t).fill(0), s = this._outputDataCreator.createDeterministicData(0, this._seed, e, a, o), { outputs: c, signatures: l } = await this.mint.restore({ outputs: s.map((e) => e.blindedMessage) }, io(this.mint, i)), u = this.bindRestoreResponse(c, l, s, a), d = [], f;
	...
	bindRestoreResponse(e, t, n, r) {
		this.failIf(e.length !== t.length, "Mint restore response must contain one signature for every returned output"), this.failIf(e.length > n.length || e.length > oo, "Mint restore response contains more outputs than requested");
	...
	async meltProofsOnchain(e, t, n, r) {
		...
		let a = G(t), o = this.getFeesForProofs(a), s = W(a), c = e.amount.add(i.fee_reserve).add(o);
	...
	async prepareMelt(e, t, n, r, i) {
		...
		let { keysetId: a, onCountersReserved: o, nut08Change: s = !0 } = r || {}, c = this.getKeyset(a), l = G(n), u = W(l), d = [];
	...
	async checkProofsStates(e, t) {
		let n = new TextEncoder(), r = e.map((e) => F(e.id) ? M(n.encode(e.secret)).toHex(!0) : N(n.encode(e.secret)).toHex(!0));
		this.failIf(new Set(r).size !== r.length, "Cannot check duplicate proof Ys");
		let i = [];
		for (let e = 0; e < r.length; e += 100) {
			let n = r.slice(e, e + 100), { states: a } = await this.mint.check({ Ys: n }, io(this.mint, t));
	...
	async init() {
		if (!this.info) {
			let e = await this.req({
				endpoint: U(this.mintUrl, "/v1/info"),
				method: "GET"
			});
		...
		if (!this.keychain) {
			let [e, t] = await Promise.all([this.req({
				endpoint: U(this.mintUrl, "/v1/auth/blind/keysets"),
				method: "GET"
			}), this.req({
				endpoint: U(this.mintUrl, "/v1/auth/blind/keys"),
				method: "GET"
			})]), n = e.keysets.map((e) => Mi(e)), r = t.keysets.map((e) => Ni(e)), i = Oa.mintToCacheDTO(this.mintUrl, n, r);
			this.keychain = Oa.fromCache(this.mintUrl, "auth", i), this.keychain.getCheapestKeyset();
		}
	}
	getBatMaxMint() {
		if (!this.info) throw new v("AuthManager: mint info not loaded");
		let e = this.info.nuts[22], t = K(e?.bat_max_mint, "nuts.22.bat_max_mint", this.maxPerMint);
	...
	async topUp(e) {
		...
		let s = await this.req({
			endpoint: U(this.mintUrl, "/v1/auth/blind/mint"),
			method: "POST",
			headers: o,
			requestBody: a
		});
...
function _o(e) {
	...
	let n = A.stringify(t) ?? "{}";
	return `${ho}${ve(D.fromString(n))}`;
}
function vo(e, t) {
	if (!e.startsWith(ho)) throw new v(`Invalid signing package: must start with "${ho}"`);
	let n = e.slice(7), r;
	try {
	...
	let a = i, o = a.version;
	if (o !== ho) throw new v(`Invalid signing package version: ${o}`);
	let s = a.type;
	...
	if (t?.validateDigest) {
		let e = go(a.inputs, a.outputs, a.quote);
...
function So(e, t, n, r) {
	let i = go(t, n, r), a = $e(Dn(t, n.map((e) => ({ blindedMessage: e })), r), !0);
...
var Eo = {
	computeDigests: go,
	extractSwapPackage: bo,
	extractMeltPackage: xo,
	serializePackage: _o,
	deserializePackage: vo,
	signPackage: yo,
	signDigest: et,
	mergeSwapPackage: Co,
	mergeMeltPackage: wo
...
//#endregion
export { k as Amount, O as AmountError, oe as AmountWithUnit, ae as AmountWithUnitError, fo as AuthManager, lt as BLS_FR_ORDER, ut as BLS_G2_GENERATOR, ct as BLS_HASH_TO_CURVE_DST, v as CTSError, Ea as CashuMint, Ea as Mint, lo as CashuWallet, lo as Wallet, J as CheckStateEnum, ne as ConsoleLogger, y as HttpResponseError, A as JSONInt, Oa as KeyChain, Da as Keyset, no as MeltBuilder, ro as MeltOnchainBuilder, Ii as MeltQuoteState, to as MintBuilder, q as MintInfo, S as MintOperationError, Fi as MintQuoteState, b as NetworkError, Pi as OIDCAuth, Q as OutputData, an as P2BK_DST, za as P2PKBuilder, $r as PaymentRequest, fr as PaymentRequestTransportType, x as RateLimitError, eo as ReceiveBuilder, $a as SendBuilder, Eo as SigAll, un as SigFlags, Ta as WSConnection, qa as WalletCounters, Za as WalletEvents, Qa as WalletOps, Lt as asBlsG1Point, It as asSecpPoint, Yt as assertSecretKind, En as assertSigAllInputs, Tt as batchVerifyUnblindedSignatureBls, si as bigIntStringify, Nt as blindMessage, yt as blindMessageBls, zn as buildLegacyP2PKSigAllMessage, Dn as buildP2PKSigAllMessage, $e as computeMessageDigest, Ft as constructUnblindedSignature, xt as constructUnblindedSignatureBls, mo as createAuthWallet, jt as createBlindSignature, St as createBlindSignatureBls, Gn as createDLEQProof, Ka as createEphemeralCounterSource, ir as createHTLCHash, nr as createHTLCsecret, Gt as createNewMintKeys, pn as createP2PKsecret, Mt as createRandomRawBlindedMessage, At as createRandomSecretKey, qt as createSecret, Zn as createSecretAndBlindingFactorDeriver, Bt as decodeKeysetCurve, Ci as decodePaymentRequest, L as dedupeP2PKPubkeys, wt as deriveBatchWeights, Yn as deriveBlindingFactor, ot as deriveConditionalKeysetId, gi as deriveKeysetId, on as deriveP2BKBlindedPubkeys, cn as deriveP2BKSecretKey, sn as deriveP2BKSecretKeys, Jn as deriveSecret, Xn as deriveSecretAndBlindingFactor, Wt as deserializeMintKeys, Si as deserializeProofs, rt as findSigningKey, Qt as getDataField, pi as getDecodedToken, ki as getDecodedTokenBinary, li as getEncodedToken, li as getEncodedTokenV4, Oi as getEncodedTokenBinary, _t as getG2PubKeyFromPrivKey, cr as getHTLCWitnessPreimage, ei as getKeysetAmounts, Vt as getKeysetIdInt, gn as getP2PKExpectedWitnessPubkeys, _n as getP2PKSigFlag, vn as getP2PKWitnessSignatures, kt as getPubKeyFromPrivKey, Zt as getSecretData, Xt as getSecretKind, tn as getTag, rn as getTagInt, nn as getTagScalar, $t as getTags, mi as getTokenMetadata, it as getValidSigners, ni as hasCorrespondingKey, Sn as hasP2PKSignedProof, en as hasTag, Ei as hasValidDleq, N as hashToCurve, M as hashToCurveBls, Dt as hash_e, ii as hexToNumber, xa as injectWebSocketImpl, ji as invoiceHasAmountInHRP, F as isBlsKeyset, sr as isHTLCSpendAuthorised, H as isObj, On as isP2PKSigAll, wn as isP2PKSpendAuthorised, V as isValidHex, U as joinUrls, Tn as maybeDeriveP2BKPrivateKeys, at as meetsSignerThreshold, hn as normalizeP2PKOptions, G as normalizeProofAmounts, bi as normalizeUrl, yi as nullIfUndefined, ai as numberToHexPadded64, rr as parseHTLCSecret, I as parseP2PKSecret, Jt as parseSecret, yn as parseWitnessData, Ot as pointFromBytes, P as pointFromHex, Rt as pointFromHexAuto, ht as pointFromHexG1, gt as pointFromHexG2, zt as pointToHex, et as schnorrSignDigest, tt as schnorrSignMessage, nt as schnorrVerifyMessage, Ba as selectProofsRGLI, Ut as serializeMintKeys, xi as serializeProofs, Hi as setGlobalRequestOptions, ur as signMintQuote, xn as signP2PKProof, bn as signP2PKProofs, vi as sortProofsById, B as splitAmount, wi as stripDleq, W as sumProofs, Pt as unblindSignature, bt as unblindSignatureBls, Un as verifyDLEQProof, Wn as verifyDLEQProof_reblind, ar as verifyHTLCHash, or as verifyHTLCSpendingConditions, dr as verifyMintQuoteSignature, Cn as verifyP2PKSpendingConditions, Di as verifyProofsForReceive, Kt as verifyUnblindedSignature, Ct as verifyUnblindedSignatureBls };
